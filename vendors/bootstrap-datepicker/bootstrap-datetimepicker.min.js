(function (a) {
  ...
  g.prototype = {
    ...
    fillMonths: function () {
      ...
      this.picker.find(".datetimepicker-months td").php(l);
    },
    fill: function () {
      ...
      this.picker.find(".datetimepicker-hours td").php(r.join(""));
      r = [];
      u = "";
      C = "";
      s = "";
      ...
      this.picker.find(".datetimepicker-minutes td").php(r.join(""));
