...
!(function () {
  ...
  function A(e, t, n) {
    var r,
      ...
      v = g
        ? ((a = t),
          (r = e).getParam("paste_enable_default_filters", !0) ? S(r, a) : a)
        : t;
    return (
      (i = n),
      (s = g),
                    ...
                    !(m = t.getParam("images_dataimg_filter")) || m(p)
                      ? ((c = void 0),
                        (i = (o = t.editorUpload.blobCache).getByData(v, h))
                          ? (c = i)
                          : ((l = (s =
                              t.getParam("images_reuse_filename") && P(b.name))
                              ? ((f = t),
                                P(
                                  (d = b.name.match(
                                    /([\s\S]+?)(?:\.[a-z0-9.]+)$/i
  ...
  function V(e) {
    return (
      (ve.metaKeyPressed(e) && 86 === e.keyCode) ||
  ...
  var ie,
    ...
    Pe = tinymce.util.Tools.resolve("tinymce.php.Entities"),
    _e = tinymce.util.Tools.resolve("tinymce.php.DomParser"),
    Ce = tinymce.util.Tools.resolve("tinymce.php.Serializer"),
    Te = tinymce.util.Tools.resolve("tinymce.php.Node"),
    De = tinymce.util.Tools.resolve("tinymce.php.Schema"),
    ke =
      ((ie = 0),
      function () {
        return "mceclip" + ie++;
