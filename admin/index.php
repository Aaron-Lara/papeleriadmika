...
<html lang="en">
  <script
    src="https://kit.fontawesome.com/7218e15624.js"
                    ...
                    <div class="card-body px-4 py-4-5">
                      <div class="row">
                        ...
                        <div style="text-align: center">
                          <i
                            class="fa-solid fa-barcode fa-3x"
                            style="margin: 10px"
                          ></i>
                        </div>
                        <div
                  ...
                  <div class="card">
                    <div class="card-body px-4 py-4-5">
                      <div class="row">
                        ...
                        <div style="text-align: center">
                          <i
                            class="fa-solid fa-person fa-3x"
                            style="margin: 10px"
                          ></i>
                        </div>
                        <div
                          ...
                          style="text-align: center"
                        >
                          <a href="cliente.php" class="btn btn-success btn-bg"
                            >CLIENTES</a
                          >
                        </div>
                      </div>
                  ...
                  <div class="card">
                    <div class="card-body px-4 py-4-5">
                      <div class="row">
                        ...
                        <div style="text-align: center">
                          <i
                            class="fa-solid fa-user-plus fa-3x"
                            style="margin: 10px"
                          ></i>
                        </div>
                        <div
                          ...
                          style="text-align: center"
                        >
                          <a href="usuario.php" class="btn btn-success btn-bg"
                            >USUARIOS</a
                          >
                        </div>
                      </div>
