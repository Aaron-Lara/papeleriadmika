  ...
  var t,
    e = {
      244: (t, e, i) => {
        ...
        function S(t) {
          return t instanceof L(t).phpElement || t instanceof HTMLElement;
        }
        function I(t) {
          return (
        ...
        class Ue extends we {
          ...
          _getFirstLevelChildren(t) {
            ...
            return Oe.find(t, this._config.parent).filter(
              (t) => !e.includes(t)
            );
          }
              ...
              ? (function (t, e, i) {
                  ...
                  for (const t of s) {
                    ...
                    const n = [].concat(...t.attributes),
                      s = [].concat(e["*"] || [], e[i] || []);
                    for (const e of n)
                      Ji(e, s) || t.removeAttribute(e.nodeName);
                  }
          ...
          constructor(t) {
            super(t),
              ...
              this._parent &&
                ...
                fe.on(this._element, "keydown.bs.tab", (t) =>
                  this._keydown(t)
                ));
          }
          static get NAME() {
