      ...
      7432: function (e, t, a) {
        e.exports = (function (e) {
            ...
            for (r = 0, i = c.length; r < i; ++r)
              if (
                ...
                if (
                  ...
                  } else if (se.isFinite(d) && se.isFinite(l)) {
                    t[s] = d + (l - d) * n;
                    continue;
                  }
                t[s] = l;
          ...
          (se.easing = oe),
            ...
            (se.rtl = _e);
          var ce = function (e) {
            se.extend(this, e), this.initialize.apply(this, arguments);
          };
          se.extend(ce.prototype, {
            _type: void 0,
            initialize: function () {
              this.hidden = !1;
            },
            pivot: function () {
              var e = this;
              return (
                e._view || (e._view = se.extend({}, e._model)),
                (e._start = {}),
                e
              );
            },
            transition: function (e) {
              ...
              return a && 1 !== e
                ? (r || (r = t._view = {}),
                  ...
                  me(n, r, a, e),
                  t)
                : ((t._view = se.extend({}, a)), (t._start = null), t);
            },
          ...
          var pe = {
              ...
              cancelAnimation: function (e) {
                var t = se.findIndex(this.animations, function (t) {
                  return t.chart === e;
                });
              ...
              advance: function () {
                for (var e, t, a, n, r = this.animations, i = 0; i < r.length; )
                  (t = (e = r[i]).chart),
                    ...
                    se.callback(e.render, [t, e], t),
                    se.callback(e.onAnimationProgress, [e], t),
                    e.currentStep >= a
                      ? (se.callback(e.onAnimationComplete, [e], t),
                        (t.animating = !1),
                        r.splice(i, 1))
                      : ++i;
              },
            },
            ge = se.options.resolve,
                  ...
                  Object.defineProperty(e, t, {
                    ...
                    value: function () {
                      var t = Array.prototype.slice.call(arguments),
                        r = n.apply(this, t);
                      return (
                        se.each(e._chartjs.listeners, function (e) {
          ...
          se.extend(ve.prototype, {
            ...
            buildOrUpdateElements: function () {
              var e = this,
                ...
                a = t.data || (t.data = []);
              e._data !== a &&
                (e._data && Ye(e._data, e),
                a && Object.isExtensible(a) && Le(a, e),
                (e._data = a)),
                e.resyncElements();
            },
            _configure: function () {
              ...
              e._config = se.merge(
                ...
                {
                  merger: function (e, t, a) {
                    "_meta" !== e && "data" !== e && se._merger(e, t, a);
                  },
                }
              );
            },
            ...
            _resolveDataElementOptions: function (e, t) {
              ...
              if (((n = n || {}), se.isArray(m)))
                for (s = 0, o = m.length; s < o; ++s)
                  c[(d = m[s])] = ge([n[d], u[d], _[d]], h, t, f);
              else
                for (s = 0, o = (i = Object.keys(m)).length; s < o; ++s)
                  c[(d = i[s])] = ge([n[d], u[m[d]], u[d], _[d]], h, t, f);
          ...
          function we(e, t, a, n) {
            ...
            for (
              e.beginPath(),
                e.arc(a.x, a.y, t.outerRadius, a.startAngle, a.startAngle + ke),
                r = 0;
              r < a.fullCircles;
              ++r
            )
          ...
          var Te = he.extend({
              ...
              inRange: function (e, t) {
                ...
                if (a) {
                  for (
                    var n = se.getAngleFromPoint(a, { x: e, y: t }),
                      r = n.angle,
                      i = n.distance,
                      s = a.startAngle,
                      o = a.endAngle;
              ...
              draw: function () {
                var e,
                  ...
                  r = {
                    ...
                    endAngle: a.endAngle,
                    fullCircles: Math.floor(a.circumference / ke),
                  };
                if (
                  (t.save(),
                  ...
                  for (
                    ...
                    t.fill();
                  r.endAngle = r.startAngle + (a.circumference % ke);
                }
                t.beginPath(),
                  t.arc(r.x, r.y, r.outerRadius, r.startAngle, r.endAngle),
                  ...
                  t.closePath(),
                  t.fill(),
                  a.borderWidth && xe(t, a, r),
                  t.restore();
              },
            }),
            Se = se.valueOrDefault,
            He = X.global.defaultColor;
          X._set("global", {
            elements: {
              line: {
                tension: 0.4,
                ...
                if (o.length) {
                  ...
                  for (
                    i.save(),
                      ...
                      i.lineWidth = Se(r.borderWidth, l.borderWidth),
                    ...
                    (a = o[e]._view),
                      (t = -1 === u ? se.previousItem(o, e) : o[u]),
                      a.skip ||
                        ((u !== e - 1 && !s) || -1 === u
                          ? i.moveTo(a.x, a.y)
                          : se.canvas.lineTo(i, t._view, a),
                        (u = e));
                  _ && i.closePath(), i.stroke(), i.restore();
                }
              },
            }),
            Pe = se.valueOrDefault,
            Oe = X.global.defaultColor;
          function Ae(e) {
            var t = this._view;
          ...
          var We = he.extend({
              ...
              draw: function (e) {
                var t = this._view,
                  ...
                  l = d.defaultColor;
                t.skip ||
                  ((void 0 === e || se.canvas._isPointInArea(t, e)) &&
                    ...
                    se.canvas.drawPoint(a, n, i, s, o, r)));
              },
            }),
          ...
          function Ne(e) {
            ...
            return t
              ? (e.horizontal
                  ? e.base > e.x && (t = Ie(t, "left", "right"))
                  : e.base < e.y && (t = Ie(t, "bottom", "top")),
                (a[t] = !0),
                a)
              : a;
          }
          ...
          var Je = he.extend({
              ...
              inLabelRange: function (e, t) {
                var a = this._view;
                return Ee(a) ? Ve(a, e, null) : Ve(a, null, t);
              },
              inXRange: function (e) {
            ...
            Ke = We,
            Ze = Je;
          (Ue.Arc = Ge), (Ue.Line = qe), (Ue.Point = Ke), (Ue.Rectangle = Ze);
          var $e = se._deprecated,
          ...
          function et(e, t, a) {
            var n,
              ...
              s = t.stackCount,
              o = t.pixels[e],
              d = se.isNullOrUndef(i) ? Qe(t.scale, t.pixels) : -1;
            return (
              se.isNullOrUndef(i)
          ...
          var at = be.extend({
              ...
              initialize: function () {
                var e,
                  t,
                  a = this;
                be.prototype.initialize.apply(a, arguments),
              ...
              updateElement: function (e, t, a) {
                ...
                (e._xScale = n.getScaleForId(r.xAxisID)),
                  ...
                  se.isArray(i.data[t]) && (e._model.borderSkipped = null),
              ...
              calculateBarIndexPixels: function (e, t, a, n) {
                var r = this,
                  i = "flex" === n.barThickness ? tt(t, a, n) : et(t, a, n),
                  s = r.getStackIndex(e, r.getMeta().stack),
                  o = i.start + i.chunk * s + i.chunk / 2,
                  d = Math.min(Xe(n.maxBarThickness, 1 / 0), i.chunk * i.ratio);
              ...
              draw: function () {
                var e = this,
                  ...
                  i = n.length,
                  s = 0;
                for (se.canvas.clipArea(t.ctx, t.chartArea); s < i; ++s) {
              ...
              _resolveDataElementOptions: function () {
                ...
                return (
                  (t.barPercentage = Xe(a.barPercentage, t.barPercentage)),
                  (t.barThickness = Xe(a.barThickness, t.barThickness)),
                  (t.categoryPercentage = Xe(
                    a.categoryPercentage,
                    t.categoryPercentage
                  )),
                  (t.maxBarThickness = Xe(
                    a.maxBarThickness,
                    t.maxBarThickness
                  )),
            ...
            nt = se.valueOrDefault,
            rt = se.options.resolve;
          X._set("bubble", {
            hover: { mode: "single" },
            scales: {
          ...
          var it = be.extend({
              ...
              setHoverStyle: function (e) {
                ...
                (e.$previousStyle = {
                  ...
                  (t.borderColor = nt(a.hoverBorderColor, n(a.borderColor))),
                  (t.borderWidth = nt(a.hoverBorderWidth, a.borderWidth)),
              ...
              _resolveDataElementOptions: function (e, t) {
                var a = this,
                  ...
                  i = e.custom || {},
                  s = r.data[t] || {},
                  o = be.prototype._resolveDataElementOptions.apply(
                    a,
                    arguments
                  ),
                  d = {
                ...
                return (
                  a._cachedDataOpts === o && (o = se.extend({}, o)),
                  (o.radius = rt(
                    [
                      i.radius,
                      s.r,
              ...
              callbacks: {
                ...
                label: function (e, t) {
                  var a = t.labels[e.index],
                    n = ": " + t.datasets[e.datasetIndex].data[e.index];
                  return (
                    se.isArray(a) ? ((a = a.slice())[0] += n) : (a += n), a
                  );
                },
              },
            },
          ...
          var ut = be.extend({
            ...
            update: function (e) {
              ...
              if (M < dt) {
                var g = d.rotation % dt,
                  ...
                  D = (g <= lt && y >= lt) || y >= dt + lt,
                  w = (g <= -lt && y >= -lt) || y >= ot + lt,
                  x = g === -ot || y >= ot ? -1 : Math.min(L, L * f, v, v * f),
            ...
            updateElement: function (e, t, a) {
              ...
              se.extend(e, {
                ...
                _model: {
                  ...
                  outerRadius: f,
                  innerRadius: h,
                  label: se.valueAtIndexOrDefault(m.label, t, r.data.labels[t]),
                },
              });
              var p = e._model;
              (a && o.animateRotate) ||
            ...
            calculateCircumference: function (e) {
              ...
              return t > 0 && !isNaN(e) ? dt * (Math.abs(e) / t) : 0;
            },
          ...
          var _t = at.extend({
            ...
            ct = se.options.resolve,
            ht = se.canvas._isPointInArea;
          function ft(e, t) {
          ...
          var gt = be.extend({
              ...
              updateElement: function (e, t, a) {
                ...
                (n = _.getPixelForValue("object" == typeof u ? u : NaN, t, l)),
                  ...
                  (e._model = {
                    ...
                    tension: mt(o.tension, c ? c.tension : 0),
              ...
              _resolveDatasetElementOptions: function (e) {
                var t = this,
                  ...
                  r = t.chart.options,
                  i = r.elements.line,
                  s = be.prototype._resolveDatasetElementOptions.apply(
                    t,
                    arguments
                  );
                return (
                  (s.spanGaps = mt(a.spanGaps, r.spanGaps)),
                  (s.tension = mt(a.lineTension, i.tension)),
                  (s.steppedLine = ct([
                    n.steppedLine,
                    a.steppedLine,
                    i.stepped,
                  ...
                  (s.clip = pt(
                    mt(a.clip, Mt(t._xScale, t._yScale, s.borderWidth))
                  )),
                  s
                );
              },
              ...
              updateBezierControlPoints: function () {
                ...
                if (
                  ...
                  se.splineCurveMonotone(l);
                else
                  for (e = 0, t = l.length; e < t; ++e)
                    (a = l[e]._model),
                      (n = se.splineCurve(
                        se.previousItem(l, e)._model,
                        a,
                        se.nextItem(l, e)._model,
                        o.tension
                      )),
              ...
              setHoverStyle: function (e) {
                ...
                (e.$previousStyle = {
                  ...
                  (t.borderColor = mt(a.hoverBorderColor, n(a.borderColor))),
                  (t.borderWidth = mt(a.hoverBorderWidth, a.borderWidth)),
                  (t.radius = mt(a.hoverRadius, a.radius));
              },
            }),
            yt = se.options.resolve;
          X._set("polarArea", {
            scale: {
              type: "radialLinear",
            ...
            updateElement: function (e, t, a) {
              ...
              se.extend(e, {
                ...
                _model: {
                  ...
                  label: se.valueAtIndexOrDefault(l, t, l[t]),
                },
              }),
                e.pivot();
            },
          ...
          X._set("pie", se.clone(X.doughnut)),
            X._set("pie", { cutoutPercentage: 0 });
          var Yt = ut,
            vt = se.valueOrDefault;
          X._set("radar", {
            spanGaps: !1,
          ...
          var bt = be.extend({
            ...
            updateElement: function (e, t, a) {
              ...
              (e._scale = s),
                ...
                (e._model = {
                  ...
                  borderColor: d.borderColor,
                  borderWidth: d.borderWidth,
                  tension: vt(r.tension, l ? l.tension : 0),
                  hitRadius: d.hitRadius,
                });
            },
            _resolveDatasetElementOptions: function () {
              var e = this,
                t = e._config,
                a = e.chart.options,
                n = be.prototype._resolveDatasetElementOptions.apply(
                  e,
                  arguments
                );
              return (
                (n.spanGaps = vt(t.spanGaps, a.spanGaps)),
                (n.tension = vt(t.lineTension, a.elements.line.tension)),
                n
              );
            },
            updateBezierControlPoints: function () {
              ...
              for (
                ...
                (a = o[e]._model),
                  (n = se.splineCurve(
                    se.previousItem(o, e, !0)._model,
                    a,
                    se.nextItem(o, e, !0)._model,
                    a.tension
                  )),
            ...
            setHoverStyle: function (e) {
              ...
              (e.$previousStyle = {
                ...
                (t.backgroundColor = vt(
                  a.hoverBackgroundColor,
                  n(a.backgroundColor)
                )),
                (t.borderColor = vt(a.hoverBorderColor, n(a.borderColor))),
                (t.borderWidth = vt(a.hoverBorderWidth, a.borderWidth)),
                (t.radius = vt(a.hoverRadius, a.radius));
            },
          });
          X._set("scatter", {
            hover: { mode: "single" },
          ...
          function Dt(e, t) {
            return e.native ? { x: e.x, y: e.y } : se.getRelativePosition(e, t);
          }
          function wt(e, t) {
            var a,
              n,
          ...
          function Ht(e, t, a) {
            ...
            a.axis = a.axis || "x";
            var r = St(a.axis),
              i = a.intersect ? xt(e, n) : Tt(e, n, !1, r),
              s = [];
            return i.length
          ...
          function zt(e, t, a) {
            ...
            if (
              ((n = t.outerWidth - Et(s, e, "left", "right")),
              (r = t.outerHeight - Et(s, e, "top", "bottom")),
              n !== e.w || r !== e.h)
            ) {
              (e.w = n), (e.h = r);
          ...
          var Vt = {
              ...
              update: function (e, t, a) {
                if (e) {
                  var n = e.options.layout || {},
                    r = se.options.toPadding(n.padding),
                    i = t - r.width,
                    s = a - r.height,
                    o = Ct(e.boxes),
                    d = o.vertical,
                  ...
                  Wt(d.concat(l), u),
                    ...
                    se.each(o.chartArea, function (t) {
                      var a = t.box;
                      Pt(a, e.chartArea), a.update(_.w, _.h);
                    });
                }
              },
            },
            ...
            Gt = a(Object.freeze({ __proto__: null, default: Ut })),
            qt = "$chartjs",
            Kt = "chartjs-",
            Zt = Kt + "size-monitor",
            $t = Kt + "render-monitor",
            Xt = Kt + "render-animation",
            Qt = ["animationstart", "webkitAnimationStart"],
            ea = {
          ...
          function ra(e, t, a) {
            e.addEventListener(t, a, na);
          }
          function ia(e, t, a) {
            e.removeEventListener(t, a, na);
          }
          function sa(e, t, a, n, r) {
            return {
              type: e,
              chart: t,
              native: r || null,
          ...
          function oa(e, t) {
            var a = ea[e.type] || e.type,
              n = se.getRelativePosition(e, t);
            return sa(a, t, n.x, n.y, e);
          }
          function da(e, t) {
            var a = !1,
              n = [];
          ...
          function ua(e) {
            ...
            return (
              ra(n, "scroll", i.bind(n, "expand")),
              ra(r, "scroll", i.bind(r, "shrink")),
              a
            );
          }
          function _a(e, t) {
            var a = e[qt] || (e[qt] = {}),
              n = (a.renderProxy = function (e) {
                e.animationName === Xt && t();
              });
            se.each(Qt, function (t) {
              ra(e, t, n);
            }),
                ...
                da(function () {
                  if (n.resizer) {
                    var r = a.options.maintainAspectRatio && e.parentNode,
                      i = r ? r.clientWidth : 0;
                    t(sa("resize", a)),
                      r && r.clientWidth < i && a.canvas && t(sa("resize", a));
                  }
                })
              ));
            _a(e, function () {
          ...
          var Ma = {
            ...
            removeEventListener: function (e, t, a) {
              var n = e.canvas;
              if ("resize" !== t) {
                var r = ((a[qt] || {}).proxies || {})[e.id + "_" + t];
                r && ia(n, t, r);
              } else ha(n);
            },
          };
          (se.addEvent = ra), (se.removeEvent = ia);
          var pa = Ma._enabled ? Ma : Jt,
            ga = se.extend(
              {
                initialize: function () {},
          ...
          var ya = {
                  ...
                  this._plugins.concat(r.plugins || []).forEach(function (e) {
                    if (-1 === a.indexOf(e)) {
                      var t = e.id,
                        r = i[t];
                      !1 !== r &&
                        (!0 === r && (r = se.clone(X.global.plugins[t])),
                        a.push(e),
            ...
            La = {
              ...
              registerScaleType: function (e, t, a) {
                (this.constructors[e] = t), (this.defaults[e] = se.clone(a));
              },
              ...
              getScaleDefaults: function (e) {
                return this.defaults.hasOwnProperty(e)
                  ? se.merge(Object.create(null), [X.scale, this.defaults[e]])
                  : {};
              },
              updateScaleDefaults: function (e, t) {
                var a = this;
                a.defaults.hasOwnProperty(e) &&
                  (a.defaults[e] = se.extend(a.defaults[e], t));
              },
              addScalesToLayout: function (e) {
                se.each(e.scales, function (t) {
            ...
            Ya = se.valueOrDefault,
            va = se.rtl.getRtlAdapter;
          X._set("global", {
            tooltips: {
              enabled: !0,
              custom: null,
              ...
              for (a = 0, n = e.length; a < n; ++a) {
                ...
                if (d && d.hasValue()) {
                  var l = d.getCenterPoint(),
                    u = se.distanceBetweenPoints(t, l);
                  u < o && ((o = u), (r = d));
                }
              }
              if (r) {
          ...
          function ka(e, t) {
            return (
              t &&
                (se.isArray(t) ? Array.prototype.push.apply(e, t) : e.push(t)),
              e
            );
          }
          function Da(e) {
          ...
          function xa(e) {
            ...
            return {
              ...
              _bodyFontFamily: Ya(e.bodyFontFamily, t.defaultFontFamily),
              _bodyFontStyle: Ya(e.bodyFontStyle, t.defaultFontStyle),
              _bodyAlign: e.bodyAlign,
              bodyFontSize: Ya(e.bodyFontSize, t.defaultFontSize),
              bodySpacing: e.bodySpacing,
              titleFontColor: e.titleFontColor,
              _titleFontFamily: Ya(e.titleFontFamily, t.defaultFontFamily),
              _titleFontStyle: Ya(e.titleFontStyle, t.defaultFontStyle),
              titleFontSize: Ya(e.titleFontSize, t.defaultFontSize),
              _titleAlign: e.titleAlign,
              titleSpacing: e.titleSpacing,
              titleMarginBottom: e.titleMarginBottom,
              footerFontColor: e.footerFontColor,
              _footerFontFamily: Ya(e.footerFontFamily, t.defaultFontFamily),
              _footerFontStyle: Ya(e.footerFontStyle, t.defaultFontStyle),
              footerFontSize: Ya(e.footerFontSize, t.defaultFontSize),
          ...
          function Ta(e, t) {
            ...
            return (
              (a.font = se.fontString(
                l,
                t._titleFontStyle,
                t._titleFontFamily
              )),
              se.each(t.title, c),
              (a.font = se.fontString(u, t._bodyFontStyle, t._bodyFontFamily)),
              se.each(t.beforeBody.concat(t.afterBody), c),
              (m = t.displayColors ? u + 2 : 0),
              se.each(i, function (e) {
                se.each(e.before, c), se.each(e.lines, c), se.each(e.after, c);
              }),
              (m = 0),
              (a.font = se.fontString(
                _,
          ...
          var Oa = he.extend({
              initialize: function () {
                (this._model = xa(this._options)), (this._lastActive = []);
              },
              getTitle: function () {
                var e = this,
                  ...
                  i = [];
                return (
                  (i = ka(i, Da(a))), (i = ka(i, Da(n))), (i = ka(i, Da(r)))
                );
              },
              ...
              getBody: function (e, t) {
                ...
                return (
                  se.each(e, function (e) {
                    ...
                    ka(i.before, Da(n.beforeLabel.call(a, e, t))),
                      ka(i.lines, n.label.call(a, e, t)),
                      ka(i.after, Da(n.afterLabel.call(a, e, t))),
                      r.push(i);
                  }),
                  r
                );
              ...
              update: function (e) {
                ...
                if (o.length) {
                  ...
                  var c = [],
                    h = [];
                  m = ba[r.position].call(n, o, n._eventPosition);
                  var f = [];
                  for (t = 0, a = o.length; t < a; ++t) f.push(wa(o[t]));
                  r.filter &&
                    ...
                    (s.labelTextColors = h),
                    (s.dataPoints = f),
                    (u = Ha(s, (_ = Ta(this, s)), (l = Sa(this, _)), n._chart));
                } else s.opacity = 0;
                return (
                  (s.xAlign = l.xAlign),
                  (s.yAlign = l.yAlign),
              ...
              drawTitle: function (e, t, a) {
                var n,
                  ...
                  o = s.length;
                if (o) {
                  var d = va(t.rtl, t.x, t.width);
                  for (
                    e.x = ja(t, t._titleAlign),
              ...
              drawBody: function (e, t, a) {
                ...
                (M = 0), se.each(t.afterBody, y), (e.y -= m);
              },
              drawFooter: function (e, t, a) {
                var n,
                  ...
                  s = i.length;
                if (s) {
                  var o = va(t.rtl, t.x, t.width);
                  for (
                    e.x = ja(t, t._footerAlign),
              ...
              handleEvent: function (e) {
                ...
                return (
                  ...
                  (n = !se.arrayEquals(t._active, t._lastActive)) &&
              ...
              merger: function (e, t, a, n) {
                if ("xAxes" === e || "yAxes" === e) {
                  ...
                  for (t[e] || (t[e] = []), r = 0; r < o; ++r)
                    (s = a[e][r]),
                      (i = Wa(s.type, "xAxes" === e ? "category" : "linear")),
                      r >= t[e].length && t[e].push({}),
                      !t[e][r].type || (s.type && s.type !== t[e][r].type)
                        ? se.merge(t[e][r], [La.getScaleDefaults(i), s])
                        : se.merge(t[e][r], s);
                } else se._merger(e, t, a, n);
              },
            });
          }
          function Ea() {
            return se.merge(Object.create(null), [].slice.call(arguments), {
              merger: function (e, t, a, n) {
                ...
                "scales" === e
                  ? (t[e] = Ca(r, i))
                  : "scale" === e
                  ? (t[e] = se.merge(r, [La.getScaleDefaults(i.type), i]))
                  : se._merger(e, t, a, n);
              },
            });
          }
          function za(e) {
            ...
            return (
              ...
              (t.labels = t.labels || []),
              (e.options = Ea(X.global, X[e.type], e.options || {})),
              e
            );
          }
          function Ia(e) {
            ...
            se.each(e.scales, function (t) {
              ...
              (t = Ea(X.global, X[e.config.type], t)),
          ...
          se.extend(Va.prototype, {
            construct: function (e, t) {
              var a = this;
              t = za(t);
              var n = ga.acquireContext(e, t),
                r = n && n.canvas,
                i = r && r.height,
                s = r && r.width;
              (a.id = se.uid()),
            ...
            clear: function () {
              return se.canvas.clear(this), this;
            },
            stop: function () {
            ...
            resize: function (e) {
              var t = this,
                ...
                i = Math.max(0, Math.floor(se.getMaximumWidth(n))),
                s = Math.max(0, Math.floor(r ? i / r : se.getMaximumHeight(n)));
              if (
                ...
                (n.style.width = i + "px"),
                (n.style.height = s + "px"),
                se.retinaScale(t, a.devicePixelRatio),
                !e)
              ) {
            ...
            ensureScalesHaveIDs: function () {
              var e = this.options,
                t = e.scales || {},
                a = e.scale;
              se.each(t.xAxes, function (e, a) {
                e.id || (e.id = Na(t.xAxes, "x-axis-", a));
              }),
                se.each(t.yAxes, function (e, a) {
                  e.id || (e.id = Na(t.yAxes, "y-axis-", a));
                }),
                a && (a.id = a.id || "scale");
            },
            buildOrUpdateScales: function () {
              ...
              t.scales &&
                ...
                se.each(n, function (t) {
                  var n = t.options,
                    i = n.id,
                    s = Wa(n.type, t.dtype);
                  Ra(n.position) !== Ra(t.dposition) &&
                  ...
                  if (i in a && a[i].type === s)
                    ...
                    var d = La.getScaleConstructor(s);
                    if (!d) return;
                    (o = new d({
                      id: i,
                      type: s,
            ...
            updateLayout: function () {
              ...
              !1 !== ya.notify(e, "beforeLayout") &&
                (Vt.update(this, this.width, this.height),
                (e._layers = []),
                se.each(
                  e.boxes,
                  function (t) {
            ...
            render: function (e) {
              ...
              var a = t.options.animation,
                n = Wa(e.duration, a && a.duration),
                r = e.lazy;
              if (!1 !== ya.notify(t, "beforeRender")) {
                var i = function (e) {
                  ya.notify(t, "afterRender"),
                    se.callback(a && a.onComplete, [e], t);
                };
                if (a && n) {
                  var s = new Me({
                    numSteps: n / 16.66,
                    ...
                    render: function (e, t) {
                      var a = se.easing.effects[t.easing],
                        n = t.currentStep,
                        r = n / t.numSteps;
                      e.draw(a(r), r, n);
                    },
                  ...
                  pe.addAnimation(t, s, n, r);
                } else t.draw(), i(new Me({ numSteps: 0, chart: t }));
                return t;
              }
            },
            draw: function (e) {
            ...
            _getSortedDatasetMetas: function (e) {
              ...
              return r.sort(Ba("order", "index")), r;
            },
            ...
            getElementAtEvent: function (e) {
              return jt.modes.single(this, e);
            },
            getElementsAtEvent: function (e) {
              return jt.modes.label(this, e, { intersect: !0 });
            },
            getElementsAtXAxis: function (e) {
              return jt.modes["x-axis"](this, e, { intersect: !0 });
            },
            ...
            getDatasetAtEvent: function (e) {
              return jt.modes.dataset(this, e, { intersect: !0 });
            },
            ...
            destroy: function () {
              ...
              n &&
                (a.unbindEvents(),
                se.canvas.clear(a),
                ga.releaseContext(a.ctx),
                (a.canvas = null),
                (a.ctx = null)),
                ya.notify(a, "destroy"),
                delete Va.instances[a.id];
            },
            ...
            bindEvents: function () {
              ...
              se.each(e.options.events, function (n) {
                ga.addEventListener(e, n, a), (t[n] = a);
              }),
                e.options.responsive &&
                  ((a = function () {
                    e.resize();
                  }),
                  ga.addEventListener(e, "resize", a),
                  (t.resize = a));
            },
            ...
            handleEvent: function (e) {
              ...
              return (
                ...
                (r = !se.arrayEquals(t.active, t.lastActive)),
          ...
          var Ua = function () {
            ...
            (se.where = function (e, t) {
              ...
              (se.findNextWhere = function (e, t, a) {
                se.isNullOrUndef(a) && (a = -1);
                for (var n = a + 1; n < e.length; n++) {
                  var r = e[n];
                  if (t(r)) return r;
                }
              }),
              (se.findPreviousWhere = function (e, t, a) {
                se.isNullOrUndef(a) && (a = e.length);
                for (var n = a - 1; n >= 0; n--) {
                  var r = e[n];
                  if (t(r)) return r;
                }
              ...
              (se.almostEquals = function (e, t, a) {
              ...
              (se._alignPixel = function (e, t, a) {
                var n = e.currentDevicePixelRatio,
                  r = a / 2;
                return Math.round((t - r) * n) / n + r;
              }),
              (se.splineCurve = function (e, t, a, n) {
                var r = e.skip ? t : e,
                  i = t,
                  s = a.skip ? t : a,
                  o = Math.sqrt(
              ...
              (se.splineCurveMonotone = function (e) {
                ...
                for (t = 0; t < _ - 1; ++t)
                  (n = u[t]),
                    ...
                    n.model.skip ||
                      r.model.skip ||
                      (se.almostEquals(n.deltaK, 0, this.EPSILON)
                        ? (n.mK = r.mK = 0)
                        : ((i = n.mK / n.deltaK),
                          (s = r.mK / n.deltaK),
              ...
              (se.previousItem = function (e, t, a) {
                return a
                  ? t <= 0
                    ? e[e.length - 1]
                    : e[t - 1]
              ...
              (se.getRelativePosition = function (e, t) {
                ...
                var d = parseFloat(se.getStyle(i, "padding-left")),
                  l = parseFloat(se.getStyle(i, "padding-top")),
                  u = parseFloat(se.getStyle(i, "padding-right")),
                  _ = parseFloat(se.getStyle(i, "padding-bottom")),
              ...
              (se._calculatePadding = function (e, t, a) {
                return (t = se.getStyle(e, t)).indexOf("%") > -1
                  ? (a * parseInt(t, 10)) / 100
                  : parseInt(t, 10);
              }),
              ...
              (se.getMaximumWidth = function (e) {
                ...
                var a = t.clientWidth,
                  n =
                    a -
                    se._calculatePadding(t, "padding-left", a) -
                    se._calculatePadding(t, "padding-right", a),
                  r = se.getConstraintWidth(e);
              ...
              (se.getMaximumHeight = function (e) {
                ...
                var a = t.clientHeight,
                  n =
                    a -
                    se._calculatePadding(t, "padding-top", a) -
                    se._calculatePadding(t, "padding-bottom", a),
                  r = se.getConstraintHeight(e);
                return isNaN(r) ? n : Math.min(n, r);
              }),
              ...
              (se.fontString = function (e, t, a) {
                return t + " " + e + "px " + a;
              }),
              (se.longestText = function (e, t, a, n) {
                ...
                var s,
                  ...
                  m = a.length;
                for (s = 0; s < m; s++)
                  if (null != (l = a[s]) && !0 !== se.isArray(l))
                    _ = se.measureText(e, r, i, _, l);
                  else if (se.isArray(l))
                    for (o = 0, d = l.length; o < d; o++)
                      null == (u = l[o]) ||
                        se.isArray(u) ||
                        (_ = se.measureText(e, r, i, _, u));
                var c = i.length / 2;
                if (c > a.length) {
              ...
              (se.measureText = function (e, t, a, n, r) {
                var i = t[r];
                return (
              ...
              (se.numberOfLabelLines = function (e) {
                ...
                return (
                  se.each(e, function (e) {
                    se.isArray(e) && e.length > t && (t = e.length);
                  }),
                  t
                );
              }),
          ...
          se.extend(qa.prototype, {
            ...
            (qa.override = function (e) {
              se.extend(qa.prototype, e);
            });
          var Ka = { _date: qa },
            Za = {
              formatters: {
                ...
                logarithmic: function (e, t, a) {
                  var n = e / Math.pow(10, Math.floor(se.log10(e)));
                  return 0 === e
                    ? "0"
                    : 1 === n ||
                      2 === n ||
            ...
            $a = se.isArray,
            Xa = se.isNullOrUndef,
            Qa = se.valueOrDefault,
            en = se.valueAtIndexOrDefault;
          function tn(e, t) {
            for (
                ...
                if ($a(o))
                  for (i = 0, s = o.length; i < s; ++i)
                    (h = o[i]),
                      Xa(h) ||
                        $a(h) ||
                        ((m = se.measureText(e, u.data, u.gc, m, h)), (c += _));
              } else (m = se.measureText(e, u.data, u.gc, m, o)), (c = _);
              g.push(m),
                y.push(c),
                L.push(_ / 2),
                (Y = Math.max(m, Y)),
          ...
          function on(e) {
            ...
            return e.display
              ? ((t = se.options._parseFont(e)),
                (a = se.options.toPadding(e.padding)),
          ...
          function dn(e, t) {
            return se.extend(
              se.options._parseFont({
                fontFamily: Qa(t.fontFamily, e.fontFamily),
                fontSize: Qa(t.fontSize, e.fontSize),
                fontStyle: Qa(t.fontStyle, e.fontStyle),
                lineHeight: Qa(t.lineHeight, e.lineHeight),
              }),
              {
          ...
          function mn(e, t, a, n) {
            ...
            for (s = 0, o = (r = se.math._factorize(d)).length - 1; s < o; s++)
              if ((i = r[s]) > l) return i;
            return Math.max(l, 1);
          }
          function cn(e) {
          ...
          function fn(e, t, a, n) {
            var r,
              ...
              o,
              d = Qa(a, 0),
              l = Math.min(Qa(n, e.length), e.length),
              u = 0;
            for (
              t = Math.ceil(t),
          ...
          var Mn = he.extend({
            ...
            update: function (e, t, a) {
              ...
              return (
                (d._ticks = s),
                (o = u < s.length),
                (i = d._convertTicksToLabels(o ? tn(s, u) : s)),
                d._configure(),
            ...
            afterBuildTicks: function (e) {
              var t = this;
              return $a(e) && e.length
                ? se.callback(t.options.afterBuildTicks, [t, e])
                : ((t.ticks =
                    se.callback(t.options.afterBuildTicks, [t, t.ticks]) ||
                    t.ticks),
                  e);
            },
            ...
            fit: function () {
              var e = this,
                ...
                l = e.isHorizontal();
              if (
                (l ? (t.width = e.maxWidth) : o && (t.width = sn(s) + on(i)),
                l ? o && (t.height = sn(s) + on(i)) : (t.height = e.maxHeight),
                r.display && o)
              ) {
                var u = ln(r),
                  _ = e._getLabelSizes(),
                ...
                if (l) {
                  var g = 0 !== e.labelRotation,
                    y = se.toRadians(e.labelRotation),
                    L = Math.cos(y),
                    Y = Math.sin(y),
                    v =
                      Y * h.width +
            ...
            _autoSkip: function (e) {
              var t,
                ...
                l = s.major.enabled ? cn(e) : [],
                u = l.length,
                _ = l[0],
                m = l[u - 1];
              if (u > d) return hn(e, l, u / d), un(e);
              if (((n = mn(l, e, o, d)), u > 0)) {
                for (t = 0, a = u - 1; t < a; t++) fn(e, n, l[t], l[t + 1]);
                return (
                  (r = u > 1 ? (m - _) / (u - 1) : null),
                  fn(e, n, se.isNullOrUndef(r) ? 0 : _ - r, _),
                  fn(e, n, m, se.isNullOrUndef(r) ? e.length : m + r),
                  un(e)
                );
              }
              return fn(e, n), un(e);
            ...
            _tickSize: function () {
              var e = this,
                t = e.options.ticks,
                a = se.toRadians(e.labelRotation),
            ...
            _computeGridLineItems: function (e) {
              var t,
                ...
                x = sn(Y),
                T = [],
                S = Y.drawBorder ? en(Y.lineWidth, 0, 0) : 0,
                H = S / 2,
                j = se._alignPixel,
                P = function (e) {
                  return j(y, e, S);
            ...
            _computeLabelItems: function () {
              var e,
                ...
                L = h.padding,
                Y = sn(c.gridLines),
                v = -se.toRadians(m.labelRotation),
                b = [];
              for (
                "top" === f
            ...
            _drawGrid: function (e) {
              ...
              if (a.display) {
                var n,
                  ...
                  l = t.chart,
                  u = se._alignPixel,
                  _ = a.drawBorder ? en(a.lineWidth, 0, 0) : 0,
                  m =
                    t._gridLineItems ||
                ...
                if (_) {
                  var c,
                    ...
                    M,
                    p = _,
                    g = en(a.lineWidth, m.ticksLength - 1, 1),
                    y = m.borderValue;
                  t.isHorizontal()
                    ? ((c = u(l, t.left, p) - p / 2),
                      (h = u(l, t.right, g) + g / 2),
            ...
            _drawTitle: function () {
              ...
              if (n.display) {
                var r,
                  i,
                  s = Qa(n.fontColor, X.global.defaultFontColor),
                  o = se.options._parseFont(n),
                  d = se.options.toPadding(n.padding),
                  l = o.lineHeight / 2,
                  u = a.position,
                  _ = 0;
                if (e.isHorizontal())
            ...
            Ln = pn.extend({
              ...
              getPixelForValue: function (e, t, a) {
                var n,
                  ...
                  s = this;
                return (
                  gn(t) || gn(a) || (e = s.chart.data.datasets[a].data[t]),
                  gn(e) || (n = s.isHorizontal() ? e.x : e.y),
          ...
          function kn(e, t) {
            var a,
              ...
              h = t.min,
              f = t.max,
              M = se.niceNum((f - h) / u / l) * l;
            if (M < o && bn(_) && bn(m)) return [h, f];
            (i = Math.ceil(f / M) - Math.floor(h / M)) > u &&
              (M = se.niceNum((i * M) / u / l) * l),
              d || bn(c)
                ? (a = Math.pow(10, se._decimalPlaces(M)))
                : ((a = Math.pow(10, c)), (M = Math.ceil(M * a) / a)),
              (n = Math.floor(h / M) * M),
              (r = Math.ceil(f / M) * M),
              d &&
                (!bn(_) && se.almostWhole(_ / M, M / 1e3) && (n = _),
                !bn(m) && se.almostWhole(m / M, M / 1e3) && (r = m)),
              (i = (r - n) / M),
              (i = se.almostEquals(i, Math.round(i), M / 1e3)
                ? Math.round(i)
                : Math.ceil(i)),
              (n = Math.round(n * a) / a),
              (r = Math.round(r * a) / a),
            ...
            return s.push(bn(m) ? r : m), s;
          }
          var Dn = pn.extend({
              getRightValue: function (e) {
                return "string" == typeof e
                  ? +e
                  : pn.prototype.getRightValue.call(this, e);
              },
              ...
              buildTicks: function () {
                var e = this,
                  ...
                  n = {
                    ...
                    stepSize: se.valueOrDefault(t.fixedStepSize, t.stepSize),
                  },
                  r = (e.ticks = kn(n, e));
            ...
            wn = {
              position: "left",
              ticks: { callback: Za.formatters.linear },
            },
            xn = 0,
            Tn = 1;
          function Sn(e, t, a) {
          ...
          var Pn = Dn.extend({
              determineDataLimits: function () {
                ...
                for (e = 0; e < u; ++e)
                  (a = s[(t = o[e]).index].data),
                    d ? Hn(r, l, t, a) : jn(r, t, a);
                se.each(l, function (e) {
                  (n = e.pos.concat(e.neg)),
                    (r.min = Math.min(r.min, se.min(n))),
                    (r.max = Math.max(r.max, se.max(n)));
                }),
                  (r.min = se.isFinite(r.min) && !isNaN(r.min) ? r.min : xn),
                  (r.max = se.isFinite(r.max) && !isNaN(r.max) ? r.max : Tn),
              ...
              _computeTickLimit: function () {
                ...
                return t.isHorizontal()
                  ...
                  : ((e = se.options._parseFont(t.options.ticks)),
            ...
            On = wn;
          Pn._defaults = On;
          var An = se.valueOrDefault,
            Fn = se.math.log10;
          function Wn(e, t) {
            var a,
              n,
              r = [],
              i = An(e.min, Math.pow(10, Math.floor(Fn(t.min)))),
              s = Math.floor(Fn(t.max)),
              o = Math.ceil(t.max / Math.pow(10, s));
            0 === i
              ? ((a = Math.floor(Fn(t.minNotZero))),
          ...
          var Cn = {
            position: "left",
            ticks: { callback: Za.formatters.logarithmic },
          };
          function En(e, t) {
          ...
          var zn = pn.extend({
              determineDataLimits: function () {
                ...
                (s.min = se.isFinite(s.min) ? s.min : null),
                  (s.max = se.isFinite(s.max) ? s.max : null),
                  (s.minNotZero = se.isFinite(s.minNotZero)
                    ? s.minNotZero
                    : null),
              ...
              handleTickRangeOptions: function () {
                var e = this,
                  ...
                  a = 1,
                  n = 10;
                (e.min = En(t.min, e.min)),
                  (e.max = En(t.max, e.max)),
                  e.min === e.max &&
                    (0 !== e.min && null !== e.min
                      ? ((e.min = Math.pow(10, Math.floor(Fn(e.min)) - 1)),
                        (e.max = Math.pow(10, Math.floor(Fn(e.max)) + 1)))
                      : ((e.min = a), (e.max = n))),
                  null === e.min &&
                    (e.min = Math.pow(10, Math.floor(Fn(e.max)) - 1)),
                  null === e.max &&
                    (e.max =
                      0 !== e.min
                        ? Math.pow(10, Math.floor(Fn(e.min)) + 1)
                        : n),
                  null === e.minNotZero &&
                    (e.min > 0
                      ? (e.minNotZero = e.min)
                      : e.max < 1
                      ? (e.minNotZero = Math.pow(10, Math.floor(Fn(e.max))))
                      : (e.minNotZero = a));
              },
              buildTicks: function () {
                var e = this,
              ...
              convertTicksToLabels: function () {
                (this.tickValues = this.ticks.slice()),
                  pn.prototype.convertTicksToLabels.call(this);
              },
              getLabelForIndex: function (e, t) {
                return this._getScaleLabel(this.chart.data.datasets[t].data[e]);
              },
              ...
              _configure: function () {
                ...
                pn.prototype._configure.call(e),
                  0 === t &&
                    ...
                    (a =
                      An(e.options.ticks.fontSize, X.global.defaultFontSize) /
                      e._length)),
                  (e._startValue = Fn(t)),
                  (e._valueOffset = a),
                  (e._valueRange = (Fn(e.max) - Fn(t)) / (1 - a));
              },
              getPixelForValue: function (e) {
                var t = this,
                  a = 0;
                return (
                  (e = +t.getRightValue(e)) > t.min &&
                    e > 0 &&
                    (a =
                      (Fn(e) - t._startValue) / t._valueRange + t._valueOffset),
            ...
            In = Cn;
          zn._defaults = In;
          var Nn = se.valueOrDefault,
            Rn = se.valueAtIndexOrDefault,
            Bn = se.options.resolve,
            Vn = {
              display: !0,
              animate: !0,
              position: "chartArea",
          ...
          function Jn(e) {
            ...
            return t.display && e.display
              ? Nn(t.fontSize, X.global.defaultFontSize) +
                  2 * t.backdropPaddingY
              : 0;
          }
          function Un(e, t, a) {
            return se.isArray(a)
              ? { w: se.longestText(e, e.font, a), h: a.length * t }
          ...
          function qn(e) {
            var t,
              a,
              n,
              r = se.options._parseFont(e.options.pointLabels),
            ...
            for (t = 0; t < o; t++) {
              (n = e.getPointPosition(t, e.drawingArea + 5)),
                (a = Un(e.ctx, r.lineHeight, e.pointLabels[t])),
                (e._pointLabelSizes[t] = a);
              var d = e.getIndexAngle(t),
                l = se.toDegrees(d) % 360,
                u = Gn(l, n.x, a.w, 0, 180),
                _ = Gn(l, n.y, a.h, 90, 270);
          ...
          var tr = Dn.extend({
              ...
              determineDataLimits: function () {
                ...
                se.each(t.data.datasets, function (r, i) {
                  if (t.isDatasetVisible(i)) {
                    var s = t.getDatasetMeta(i);
                    se.each(r.data, function (t, r) {
              ...
              convertTicksToLabels: function () {
                var e = this;
                Dn.prototype.convertTicksToLabels.call(e),
              ...
              _drawGrid: function () {
                var e,
                  ...
                  s = i.gridLines,
                  o = i.angleLines,
                  d = Nn(o.lineWidth, s.lineWidth),
                  l = Nn(o.color, s.color);
                if (
                  (i.pointLabels.display && Xn(n),
                  s.display &&
                    se.each(n.ticks, function (e, a) {
                      0 !== a &&
                  ...
                  for (
                    r.save(),
                      ...
                      r.strokeStyle = l,
                      r.setLineDash &&
                        (r.setLineDash(Bn([o.borderDash, s.borderDash, []])),
                        (r.lineDashOffset = Bn([
                          o.borderDashOffset,
                          s.borderDashOffset,
                          0,
              ...
              _drawLabels: function () {
                ...
                if (a.display) {
                  var n,
                    r,
                    i = e.getIndexAngle(0),
                    s = se.options._parseFont(a),
                    o = Nn(a.fontColor, X.global.defaultFontColor);
                  t.save(),
                    (t.font = s.string),
            ...
            ar = Vn;
          tr._defaults = ar;
          var nr = se._deprecated,
            rr = se.options.resolve,
            ir = se.valueOrDefault,
            sr = Number.MIN_SAFE_INTEGER || -9007199254740991,
          ...
          function pr(e, t) {
            ...
            return (
              ...
              null !== s
                ...
                : (r ||
                    "function" != typeof i ||
                    ((s = i(t)), se.isFinite(s) || (s = a.parse(s))),
                  s)
            );
          }
          function gr(e, t) {
          ...
          function yr(e, t, a, n) {
            var r,
              ...
              s,
              o = lr.length;
            for (r = lr.indexOf(e); r < o - 1; ++r)
              if (
                ((s = (i = dr[lr[r]]).steps ? i.steps : or),
          ...
          function Lr(e, t, a, n, r) {
            var i, s;
            for (i = lr.length - 1; i >= lr.indexOf(a); i--)
              if (
                ((s = lr[i]), dr[s].common && e._adapter.diff(r, n, s) >= t - 1)
              )
                return s;
            return lr[a ? lr.indexOf(a) : 0];
          }
          function Yr(e) {
            for (var t = lr.indexOf(e) + 1, a = lr.length; t < a; ++t)
              if (dr[lr[t]].common) return lr[t];
          }
          function vr(e, t, a, n) {
            var r,
              i = e._adapter,
              ...
              l = rr([o.stepSize, o.unitStepSize, 1]),
            ...
            return (
              r.offset &&
                ...
                (o =
                  1 === t.length
                    ? 1 - i
                    : (Mr(e, "time", t[1], "pos") - i) / 2),
                (s = Mr(e, "time", t[t.length - 1], "pos")),
                (d =
                  1 === t.length
                    ? s
                    : (s - Mr(e, "time", t[t.length - 2], "pos")) / 2)),
            ...
            xr = pn.extend({
              ...
              update: function () {
                var e = this,
                  t = e.options,
                  a = t.time || (t.time = {}),
                  n = (e._adapter = new Ka._date(t.adapters.date));
                return (
                  nr("time scale", a.format, "time.format", "time.parser"),
                  nr("time scale", a.min, "time.min", "ticks.min"),
                  nr("time scale", a.max, "time.max", "ticks.max"),
                  se.mergeIf(a.displayFormats, n.formats()),
              ...
              determineDataLimits: function () {
                var e,
                  ...
                  M = [],
                  p = o._getLabels();
                for (e = 0, a = p.length; e < a; ++e) M.push(gr(o, p[e]));
                for (e = 0, a = (d.data.datasets || []).length; e < a; ++e)
                  if (d.isDatasetVisible(e))
                    if (((r = d.data.datasets[e].data), se.isObject(r[0])))
                      for (f[e] = [], t = 0, n = r.length; t < n; ++t)
                        (i = gr(o, r[t])), h.push(i), (f[e][t] = i);
                    else
                ...
                M.length &&
                  ...
                  h.length &&
                    ((h = a > 1 ? _r(h).sort(ur) : h.sort(ur)),
                    (m = Math.min(m, h[0])),
                    (c = Math.max(c, h[h.length - 1]))),
                  (m = gr(o, mr(u)) || m),
                  (c = gr(o, cr(u)) || c),
                  (m = m === or ? +l.startOf(Date.now(), _) : m),
                  (c = c === sr ? +l.endOf(Date.now(), _) + 1 : c),
                  (o.min = Math.min(m, c)),
                ...
                return (
                  ...
                  (n._unit =
                    ...
                    (o.autoSkip
                      ...
                      : Lr(n, u.length, d.minUnit, n.min, n.max))),
                  (n._majorUnit =
                    o.major.enabled && "year" !== n._unit
                      ? Yr(n._unit)
                      : void 0),
                  (n._table = hr(n._timestamps.data, r, i, c)),
                  (n._offsets = br(n._table, u, r, i, s)),
                  o.reverse && u.reverse(),
                  Dr(n, u, n._majorUnit)
                );
              },
              getLabelForIndex: function (e, t) {
                ...
                return (
                  se.isObject(o) && (s = a.getRightValue(o)),
                  i.tooltipFormat
                    ? n.format(pr(a, s), i.tooltipFormat)
                    : "string" == typeof s
                    ? s
                    : n.format(pr(a, s), i.displayFormats.datetime)
                );
              },
              ...
              _getLabelSize: function (e) {
                var t = this,
                  ...
                  i = Math.cos(r),
                  s = Math.sin(r),
                  o = ir(a.fontSize, X.global.defaultFontSize);
              ...
              getLabelCapacity: function (e) {
                var t = this,
                  ...
                  i = t.tickFormatFunction(e, 0, Dr(t, [e], t._majorUnit), r),
                  s = t._getLabelSize(i),
                  o = Math.floor(
          ...
          function Fr(e) {
            return (e.el._scale || {}).getPointPositionForValue ? Ar(e) : Or(e);
          }
          function Wr(e, t, a) {
            var n,
              r = e[t].fill,
          ...
          function zr(e, t, a, n, r) {
            ...
            if (n && r) {
              for (e.moveTo(t[0].x, t[0].y), i = 1; i < n; ++i)
                se.canvas.lineTo(e, t[i - 1], t[i]);
              if (void 0 === a[0].angle)
                for (e.lineTo(a[r - 1].x, a[r - 1].y), i = r - 1; i > 0; --i)
                  se.canvas.lineTo(e, a[i], a[i - 1], !0);
              else
                for (
                  s = a[0].cx,
                    o = a[0].cy,
                ...
                _ && m
                  ...
                  : g &&
                    ...
                    (f
                      ...
                      : (zr(e, M, p, g, y), (g = y = 0), (M = []), (p = [])));
            zr(e, M, p, g, y), e.closePath(), (e.fillStyle = r), e.fill();
          }
          var Nr = {
              id: "filler",
                ...
                for (a = d.length - 1; a >= 0; --a)
                  (t = d[a].$filler) &&
                    ...
                    s &&
                      o &&
                      i.length &&
                      (se.canvas.clipArea(l, e.chartArea),
                      Ir(l, i, s, r, o, n._loop),
                      se.canvas.unclipArea(l)));
              },
            },
            Rr = se.rtl.getRtlAdapter,
            Br = se.noop,
            Vr = se.valueOrDefault;
          function Jr(e, t) {
          ...
          var Ur = he.extend({
            ...
            buildLabels: function () {
              var e = this,
                t = e.options.labels || {},
                a = se.callback(t.generateLabels, [e.chart], e) || [];
              t.filter &&
                ...
                if (((r.font = i.string), l)) {
                  ...
                  (r.textAlign = "left"),
                    ...
                    se.each(e.legendItems, function (e, t) {
                      var n = Jr(a, s) + s / 2 + r.measureText(e.text).width;
                      (0 === t ||
            ...
            draw: function () {
              ...
              if (t.display) {
                var u,
                  _ = Rr(t.rtl, e.left, e.minSize.width),
                  m = e.ctx,
                  c = Vr(a.fontColor, n.defaultFontColor),
                  h = se.options._parseFont(a),
                  f = h.size;
                ...
                var M = Jr(a, f),
                  ...
                  g = function (e, t, n) {
                    if (!(isNaN(M) || M <= 0)) {
                      m.save();
                      var s = Vr(n.lineWidth, i.borderWidth);
                      if (
                        ((m.fillStyle = Vr(n.fillStyle, r)),
                        (m.lineCap = Vr(n.lineCap, i.borderCapStyle)),
                        (m.lineDashOffset = Vr(
                          n.lineDashOffset,
                          i.borderDashOffset
                        )),
                        (m.lineJoin = Vr(n.lineJoin, i.borderJoinStyle)),
                        (m.lineWidth = s),
                        (m.strokeStyle = Vr(n.strokeStyle, r)),
                        m.setLineDash &&
                          m.setLineDash(Vr(n.lineDash, i.borderDash)),
                        a && a.usePointStyle)
                      ) {
                ...
                (u = Y
                  ...
                  se.rtl.overrideTextDirection(e.ctx, t.textDirection);
                var v = f + a.padding;
                se.each(e.legendItems, function (t, n) {
                  ...
                  se.rtl.restoreTextDirection(e.ctx, t.textDirection);
              }
            },
          ...
          function Gr(e, t) {
            var a = new Ur({ ctx: e.ctx, options: t, chart: e });
            Vt.configure(e, a, t), Vt.addBox(e, a), (e.legend = a);
          }
          var qr = {
              id: "legend",
              _element: Ur,
              ...
              beforeUpdate: function (e) {
                var t = e.options.legend,
                  a = e.legend;
                t
                  ? (se.mergeIf(t, X.global.legend),
                    a ? (Vt.configure(e, a, t), (a.options = t)) : Gr(e, t))
                  : a && (Vt.removeBox(e, a), delete e.legend);
              },
          ...
          var Zr = he.extend({
            initialize: function (e) {
              var t = this;
              se.extend(t, e), (t.legendHitBoxes = []);
            },
            beforeUpdate: Kr,
            update: function (e, t, a) {
              var n = this;
            ...
            fit: function () {
              ...
              a.display
                ? ((e =
                    (se.isArray(a.text) ? a.text.length : 1) *
                      se.options._parseFont(a).lineHeight +
                    2 * a.padding),
          ...
          function $r(e, t) {
            var a = new Zr({ ctx: e.ctx, options: t, chart: e });
            ...
            ti = {
              ...
              beforeUpdate: function (e) {
                var t = e.options.title,
                  a = e.titleBlock;
                t
                  ? (se.mergeIf(t, X.global.title),
                    a ? (Vt.configure(e, a, t), (a.options = t)) : $r(e, t))
                  : a && (Vt.removeBox(e, a), delete e.titleBlock);
              },
            };
          for (var ai in ((Xr.filler = Qr),
          (Xr.legend = ei),
          (Xr.title = ti),
          (Ja.helpers = se),
          Ua(),
          (Ja._adapters = Ka),
          (Ja.Animation = Me),
          (Ja.animationService = pe),
          (Ja.controllers = kt),
          (Ja.DatasetController = be),
          (Ja.defaults = X),
          (Ja.Element = he),
          (Ja.elements = Ue),
          (Ja.Interaction = jt),
          ...
          (Ja.Ticks = Za),
          (Ja.Tooltip = Fa),
          Ja.helpers.each(Sr, function (e, t) {
            Ja.scaleService.registerScaleType(t, e, e._defaults);
          }),
          Xr))
            Xr.hasOwnProperty(ai) && Ja.plugins.register(Xr[ai]);
          Ja.platform.initialize();
          var ni = Ja;
          return (
            "undefined" != typeof window && (window.Chart = Ja),
            (Ja.Chart = Ja),
            (Ja.Legend = Xr.legend._element),
            (Ja.Title = Xr.title._element),
            (Ja.pluginService = Ja.plugins),
            (Ja.PluginBase = Ja.Element.extend({})),
            (Ja.canvasHelpers = Ja.helpers.canvas),
            (Ja.layoutService = Ja.layouts),
            (Ja.LinearScaleBase = Dn),
            Ja.helpers.each(
              [
                "Bar",
                "Bubble",
        ...
        (e = a.nmd(e)).exports = (function () {
          ...
          function ma(e) {
            for (var t, a, n, r, i = 0; i < e.length; ) {
              for (
                ...
                if ((n = ca(r.slice(0, t).join("-")))) return n;
          ...
          function Ta(e) {
            var t,
              ...
              s,
              o = e._i,
              d = La.exec(o) || Ya.exec(o);
            if (d) {
              for (p(e).iso = !0, t = 0, a = ba.length; t < a; t++)
                if (ba[t][1].exec(d[1])) {
                  (r = ba[t][0]), (n = !1 !== ba[t][2]);
                  break;
                }
              ...
              if (d[4]) {
                if (!va.exec(d[4])) return void (e._isValid = !1);
                s = "Z";
              }
              (e._f = r + (i || "") + (s || "")), Ia(e);
            } else e._isValid = !1;
          }
          function Sa(e, t, a, n, r, i) {
            var s = [
              Ha(e),
              at.indexOf(t),
              parseInt(a, 10),
          ...
          function Aa(e) {
            ...
            if (a) {
              if (
                ((t = Sa(a[4], a[3], a[2], a[5], a[6], a[7])), !Pa(a[1], t, e))
              )
                return;
              (e._a = t),
                (e._tzm = Oa(a[8], a[9], a[10])),
          ...
          function Ea(e) {
            ...
            if (!e._d) {
              for (
                n = Ca(e),
                  e._w && null == e._a[Ue] && null == e._a[Je] && za(e),
                  null != e._dayOfYear &&
                    ((i = Wa(e._a[Ve], n[Ve])),
          ...
          function za(e) {
            ...
            null != (t = e._w).GG || null != t.W || null != t.E
              ? ((i = 1),
                (s = 4),
                (a = Wa(t.GG, e._a[Ve], bt(qa(), 1, 4).year)),
                (n = Wa(t.W, 1)),
                ((r = Wa(t.E, 1)) < 1 || r > 7) && (d = !0))
              : ((i = e._locale._week.dow),
                (s = e._locale._week.doy),
                (l = bt(qa(), i, s)),
                (a = Wa(t.gg, e._a[Ve], l.year)),
                (n = Wa(t.w, l.week)),
                null != t.d
                  ? ((r = t.d) < 0 || r > 6) && (d = !0)
                  : null != t.e
            ...
            if (e._f !== r.ISO_8601)
              if (e._f !== r.RFC_2822) {
                ...
                var t,
                  ...
                  u = 0;
                for (
                  n = J(e._f, e._locale).match(C) || [], t = 0;
                  t < n.length;
                  t++
                )
                  (i = n[t]),
                ...
                (p(e).charsLeftOver = l - u),
                  ...
                  (e._a[Ge] = Na(e._locale, e._a[Ge], e._meridiem)),
                  null !== (o = p(e).era) &&
            ...
            return (
              ...
              null === t || (void 0 === a && "" === t)
                ...
                : ("string" == typeof t && (e._i = t = e._locale.preparse(t)),
                  k(t)
                    ? new b(ya(t))
                    : (m(t) ? (e._d = t) : s(a) ? Ra(e) : a ? Ia(e) : Ua(e),
                      g(e) || (e._d = null),
                      e))
            );
          }
          ...
          function Xa() {
            return $a("isBefore", [].slice.call(arguments, 0));
          }
          function Qa() {
            return $a("isAfter", [].slice.call(arguments, 0));
          }
          var en = function () {
          ...
          function an(e) {
            ...
            for (t in e)
              if (
                d(e, t) &&
                (-1 === Be.call(tn, t) || (null != e[t] && isNaN(e[t])))
              )
                return !1;
            for (a = 0; a < tn.length; ++a)
              if (e[tn[a]]) {
                if (n) return !1;
                parseFloat(e[tn[a]]) !== _e(e[tn[a]]) && (n = !0);
              }
            return !0;
          }
          function nn() {
          ...
          function cn(e, t) {
            ...
            return t._isUTC
              ? ((a = t.clone()),
                (n =
                  (k(e) || m(e) ? e.valueOf() : qa(e).valueOf()) - a.valueOf()),
          ...
          function jn(e, t) {
            ...
            return e.isValid() && t.isValid()
              ? ((t = cn(t, e)),
                e.isBefore(t)
                  ? (a = Hn(e, t))
                  : (((a = Hn(t, e)).milliseconds = -a.milliseconds),
                    (a.months = -a.months)),
                a)
          ...
          function Cn(e) {
            return k(e) || m(e) || Wn(e) || _(e) || zn(e) || En(e) || null == e;
          }
          function En(e) {
            var t,
              a,
            ...
            1 === arguments.length &&
              (arguments[0]
                ? Cn(arguments[0])
                  ...
                  : In(arguments[0]) && ((t = arguments[0]), (e = void 0))
                : ((e = void 0), (t = void 0)));
            var a = e || qa(),
              n = cn(a, this).startOf("day"),
              i = r.calendarFormat(this, n) || "sameElse",
              s = t && (H(t[i]) ? t[i].call(this, a) : t[i]);
            return this.format(s || this.localeData().calendar(i, this, qa(a)));
          }
          function Bn() {
            return new b(this);
          }
          ...
          function ar(e, t) {
            return this.isValid() && ((k(e) && e.isValid()) || qa(e).isValid())
          ...
          function hr(e, t, a) {
            return e < 100 && e >= 0
              ? new Date(e + 400, t, a) - mr
              : new Date(e, t, a).valueOf();
          }
          function fr(e, t, a) {
            return e < 100 && e >= 0
              ? Date.UTC(e + 400, t, a) - mr
              : Date.UTC(e, t, a);
          }
          function Mr(e) {
            var t, a;
            ...
            switch (((a = this._isUTC ? fr : hr), e)) {
              ...
              case "hour":
                (t = this._d.valueOf()),
                  (t -= cr(t + (this._isUTC ? 0 : this.utcOffset() * ur), _r));
                break;
              case "minute":
                (t = this._d.valueOf()), (t -= cr(t, ur));
                break;
              case "second":
                (t = this._d.valueOf()), (t -= cr(t, lr));
            }
            ...
            switch (((a = this._isUTC ? fr : hr), e)) {
              ...
              case "hour":
                (t = this._d.valueOf()),
                  (t +=
                    _r -
                    cr(t + (this._isUTC ? 0 : this.utcOffset() * ur), _r) -
                    1);
                break;
              case "minute":
                (t = this._d.valueOf()), (t += ur - cr(t, ur) - 1);
                break;
              case "second":
                (t = this._d.valueOf()), (t += lr - cr(t, lr) - 1);
            }
            return this._d.setTime(t), r.updateOffset(this, !0), this;
          }
          function gr() {
          ...
          function Fr(e) {
            return (
              d(this, "_erasNameRegex") || Rr.call(this),
              e ? this._erasNameRegex : this._erasRegex
            );
          }
          function Wr(e) {
            return (
              d(this, "_erasAbbrRegex") || Rr.call(this),
              e ? this._erasAbbrRegex : this._erasRegex
            );
          }
          function Cr(e) {
            return (
              d(this, "_erasNarrowRegex") || Rr.call(this),
          ...
          for (ai = "S"; ai.length <= 9; ai += "S") Ie(ai, ii);
          function si() {
          ...
          (di.add = An),
            ...
            (di.weekYear = Vr),
            (di.isoWeekYear = Jr),
            (di.quarter = di.quarters = Xr),
            (di.month = _t),
            (di.daysInMonth = mt),
            (di.week = di.weeks = St),
            (di.isoWeek = di.isoWeeks = Ht),
            (di.weeksInYear = qr),
            (di.weeksInWeekYear = Kr),
            (di.isoWeeksInYear = Ur),
            (di.isoWeeksInISOWeekYear = Gr),
            (di.date = Qr),
            (di.day = di.days = Jt),
            (di.weekday = Ut),
            (di.isoWeekday = Gt),
            (di.dayOfYear = ei),
            (di.hour = di.hours = ra),
            (di.minute = di.minutes = ti),
            (di.second = di.seconds = ri),
            (di.millisecond = di.milliseconds = ni),
            (di.utcOffset = fn),
            (di.utc = pn),
            (di.local = gn),
            (di.parseZone = yn),
            (di.hasAlignedHourOffset = Ln),
            (di.isDST = Yn),
            (di.isLocal = bn),
            (di.isUtcOffset = kn),
            (di.isUtc = Dn),
          ...
          function hi(e, t, a) {
            if ((_(e) && ((t = e), (e = void 0)), (e = e || ""), null != t))
              return ci(e, t, a, "month");
            var n,
              r = [];
            for (n = 0; n < 12; n++) r[n] = ci(e, n, a, "month");
            return r;
          }
          function fi(e, t, a, n) {
            "boolean" == typeof e
            ...
            var r,
              ...
              s = e ? i._week.dow : 0,
              o = [];
            if (null != a) return ci(t, (a + s) % 7, n, "day");
            for (r = 0; r < 7; r++) o[r] = ci(t, (r + s) % 7, n, "day");
            return o;
          }
          function Mi(e, t) {
          ...
          function gi(e, t, a) {
            return fi(e, t, a, "weekdays");
          }
          function yi(e, t, a) {
            return fi(e, t, a, "weekdaysShort");
          }
          function Li(e, t, a) {
            return fi(e, t, a, "weekdaysMin");
          }
          (mi.calendar = F),
            (mi.longDateFormat = G),
            (mi.invalidDate = K),
            ...
            (mi.eras = Tr),
            (mi.erasParse = Sr),
            (mi.erasConvertYear = Hr),
            (mi.erasAbbrRegex = Wr),
            (mi.erasNameRegex = Fr),
            (mi.erasNarrowRegex = Cr),
            (mi.months = st),
            (mi.monthsShort = ot),
            (mi.monthsParse = lt),
            (mi.monthsRegex = ht),
            (mi.monthsShortRegex = ct),
            (mi.week = Dt),
            (mi.firstDayOfYear = Tt),
            (mi.firstDayOfWeek = xt),
            (mi.weekdays = It),
            (mi.weekdaysMin = Rt),
            (mi.weekdaysShort = Nt),
            (mi.weekdaysParse = Vt),
            (mi.weekdaysRegex = qt),
            (mi.weekdaysShortRegex = Kt),
            (mi.weekdaysMinRegex = Zt),
            (mi.isPM = aa),
            (mi.meridiem = ia),
            ha("en", {
              eras: [
          ...
          function Hi(e) {
            ...
            if ("month" === (e = re(e)) || "quarter" === e || "year" === e)
              switch (
                ((t = this._days + n / 864e5), (a = this._months + Ti(t)), e)
              ) {
                case "month":
                  return a;
                case "quarter":
          ...
          function is(e, t) {
            ...
            return (
              ...
              (n = as(this, !r, i, (a = this.localeData()))),
          ...
          function ds() {
            ...
            return _
              ? ((e = ue(d / 60)),
                ...
                (r = _ < 0 ? "-" : ""),
                (i = os(this._months) !== os(_) ? "-" : ""),
                (s = os(this._days) !== os(_) ? "-" : ""),
                (o = os(this._milliseconds) !== os(_) ? "-" : ""),
                r +
                  "P" +
                  (a ? i + a + "Y" : "") +
                  (u ? i + u + "M" : "") +
