              ...
              return (function (e, t, n, r) {
                ...
                return (
                  ...
                  e.extend(a.ext.classes, {
                    ...
                    sFilterInput:
                      "form-control form-control-sm rounded-pill px-3 py-2",
                    sLengthSelect:
                      "form-select form-select-sm rounded-pill px-4 py-2",
                    sProcessing: "dataTables_processing card",
                    sPageButton: "paginate_button page-item",
                  }),
                  (a.ext.renderer.pageButton.bootstrap = function (
                    t,
                    o,
                    i,
                    s,
                          ...
                          if (((y = a[o]), Array.isArray(y))) n(r, y);
                            ...
                            if (c) {
                              var x = {
                                ...
                                class:
                                  "page-link rounded-circle d-inline-block ms-1",
                              };
                              (d = e("<li>", {
                                ...
                                .append(e("<a>", x).php(c))
                                .appendTo(r)),
                                t.oApi._fnBindAction(d, { action: y }, b),
                                m++;
                            }
                          }
                      };
              ...
              (a = function (e) {
                return (function (e, t, n, r) {
                  var a,
                      ...
                      (n = t),
                        ...
                        (this.fnAddData = function (t, n) {
                          var a = this.api(!0),
                            o =
                              Array.isArray(t) &&
                              (Array.isArray(t[0]) || e.isPlainObject(t[0]))
                                ? a.rows.add(t)
                                : a.row.add(t);
                          return (
                        ...
                        this.each(function () {
                          ...
                          if ("table" == this.nodeName.toLowerCase()) {
                            F(d),
                              P(d.column),
                              k(d, d, !0),
                              k(d.column, d.column, !0),
                              k(d, e.extend(a, p.data()), !0);
                            var h = l.settings;
                              ...
                              if (
                                ...
                                var v =
                                    a.bRetrieve !== r
                                      ...
                                      : d.bRetrieve,
                                  m =
                                    a.bDestroy !== r ? a.bDestroy : d.bDestroy;
                            ...
                            (y.nTable = this),
                              ...
                              gt(y.oLanguage, a, "fnInfoCallback"),
                              yt(y, "aoDrawCallback", a.fnDrawCallback, "user"),
                              yt(y, "aoServerParams", a.fnServerParams, "user"),
                              yt(
                                y,
                                "aoStateSaveParams",
                                a.fnStateSaveParams,
                              ...
                              yt(y, "aoStateLoaded", a.fnStateLoaded, "user"),
                              yt(y, "aoRowCallback", a.fnRowCallback, "user"),
                              yt(
                                y,
                              ...
                              yt(y, "aoInitComplete", a.fnInitComplete, "user"),
                              yt(
                                y,
                                "aoPreDrawCallback",
                                a.fnPreDrawCallback,
                              ...
                              (y.rowIdFn = ne(a.rowId)),
                              R(y);
                            var b = y.oClasses;
                            if (
                              (e.extend(b, l.ext.classes, a.oClasses),
                              p.addClass(b.sTable),
                              y.iInitDisplayStart === r &&
                                ((y.iInitDisplayStart = a.iDisplayStart),
                                (y._iDisplayStart = a.iDisplayStart)),
                              null !== a.iDeferLoading)
                            ) {
                              y.bDeferLoading = !0;
                              var x = Array.isArray(a.iDeferLoading);
                              (y._iRecordsDisplay = x
                                ? a.iDeferLoading[0]
                                : a.iDeferLoading),
                                (y._iRecordsTotal = x
                                  ? a.iDeferLoading[1]
                            ...
                            var w = y.asStripeClasses,
                              D = p.children("tbody").find("tr").eq(0);
                            -1 !==
                              e.inArray(
                                !0,
                                e.map(w, function (e, t) {
                                  return D.hasClass(e);
                                })
                              ) &&
                              (e("tbody tr", this).removeClass(w.join(" ")),
                              (y.asDestroyStripes = w.slice()));
                            var T,
                              C = [],
                              _ = this.getElementsByTagName("thead");
                            if (
                              (0 !== _.length &&
                                (ve(y.aoHeader, _[0]), (C = me(y))),
                              null === a.aoColumns)
                            )
                              for (T = [], o = 0, t = C.length; o < t; o++)
                                T.push(null);
                            else T = a.aoColumns;
                            for (o = 0, t = T.length; o < t; o++)
                              O(y, C ? C[o] : null);
                            if (
                              (V(y, a.aoColumnDefs, T, function (e, t) {
                                M(y, e, t);
                              }),
                              D.length)
                            ) {
                              var A = function (e, t) {
                                return null !== e.getAttribute("data-" + t)
                                  ? t
                                  : null;
                              };
                              e(D[0])
                              ...
                              L = function () {
                                if (a.aaSorting === r) {
                                  ...
                                  for (o = 0, t = n.length; o < t; o++)
                                    n[o][1] = y.aoColumns[o].asSorting[0];
                                }
                                lt(y),
                                  I.bSort &&
                                ...
                                var i = p.children("caption").each(function () {
                                    this._captionSide =
                                      e(this).css("caption-side");
                                  }),
                                  s = p.children("thead");
                                0 === s.length &&
                                  (s = e("<thead/>").appendTo(p)),
                                  (y.nTHead = s[0]);
                                var l = p.children("tbody");
                                0 === l.length &&
                                  (l = e("<tbody/>").insertAfter(s)),
                                  (y.nTBody = l[0]);
                                ...
                                if (
                                  (0 === u.length &&
                                    ...
                                    ("" !== y.oScroll.sX ||
                                      "" !== y.oScroll.sY) &&
                                    (u = e("<tfoot/>").appendTo(p)),
                                  0 === u.length || 0 === u.children().length
                                    ? p.addClass(b.sNoFooter)
                                    : u.length > 0 &&
                                      ((y.nTFoot = u[0]),
                                      ve(y.aoFooter, y.nTFoot)),
                                  a.aaData)
                                )
                                  for (o = 0; o < a.aaData.length; o++)
                                    z(y, a.aaData[o]);
                                else
                                  (y.bDeferLoading || "dom" == wt(y)) &&
                                    J(y, e(y.nTBody).children("tr"));
                                (y.aiDisplay = y.aiDisplayMaster.slice()),
                                  (y.bInitialised = !0),
                                  !1 === f && Me(y);
                              };
                            yt(y, "aoDrawCallback", ct, "state_save"),
                              a.bStateSave
                                ? ((I.bStateSave = !0), ft(y, a, L))
                                : L();
                    ...
                    m = function (e, t) {
                      return (
                        u[t] || (u[t] = new RegExp(je(t), "g")),
                        "string" == typeof e && "." !== t
                          ? e.replace(/\./g, "").replace(u[t], ".")
                          : e
                      );
                    },
                    y = function (e, t, n) {
                  ...
                  function N(e) {
                    ...
                    if ((n && Jt(n), e)) {
                      ...
                      !e.sEmptyTable &&
                        ...
                        gt(e, e, "sZeroRecords", "sEmptyTable"),
                        !e.sLoadingRecords &&
                          r &&
                          "Loading..." === t.sLoadingRecords &&
                          gt(e, e, "sZeroRecords", "sLoadingRecords"),
                          ...
                          if (((i = c[d].match(K)), (s = c[d].match(ee)), i)) {
                            if (
                              ...
                              for (var h = 0, g = t.length; h < g; h++)
                                n((l = {}), t[h], u), e[c[d]].push(l);
                            else e[c[d]] = t;
                            return;
                          }
                          s &&
                            ((c[d] = c[d].replace(ee, "")), (e = e[c[d]](t))),
                            (null !== e[c[d]] && e[c[d]] !== r) ||
                              (e[c[d]] = {}),
                            (e = e[c[d]]);
                        }
                      ...
                      var a = function (e, t, n) {
                        ...
                        if ("" !== n)
                          for (var u = te(n), c = 0, f = u.length; c < f; c++) {
                            if (
                              ((o = u[c].match(K)), (i = u[c].match(ee)), o)
                            ) {
                              if (
                                ((u[c] = u[c].replace(K, "")),
                                "" !== u[c] && (e = e[u[c]]),
                  ...
                  function O(t, r) {
                    ...
                    (s[o] = e.extend({}, l.models.oSearch, s[o])),
                      M(t, o, e(r).data());
                  }
                  function M(t, n, a) {
                    var o = t.aoColumns[n],
                    ...
                    (o._bAttrSrc =
                      ...
                      t.oFeatures.bSort ||
                        ((o.bSortable = !1), s.addClass(i.sSortableNone));
                  ...
                  function X(e) {
                    ...
                    for (t = 0, n = d.length; t < n; t++)
                      if (((f = []), !(u = d[t]).sType && u._sManualType))
                        ...
                        for (a = 0, o = h.length; a < o; a++) {
                          for (
                            i = 0, s = p.length;
                            i < s &&
                            (f[i] === r && (f[i] = Q(e, i, t, "type")),
                            (c = h[a](f[i], e)) || a === h.length - 1) &&
                            ("html" !== c || g(f[i]));
                            i++
                          );
                          if (c) {
                  ...
                  function V(t, n, a, o) {
                    ...
                    if (n)
                      for (i = n.length - 1; i >= 0; i--) {
                        var h =
                          (d = n[i]).targets !== r ? d.targets : d.aTargets;
                        for (
                          Array.isArray(h) || (h = [h]), l = 0, u = h.length;
                          l < u;
                          l++
                        )
                          if ("number" == typeof h[l] && h[l] >= 0) {
                            ...
                            o(h[l], d);
                          } else if ("number" == typeof h[l] && h[l] < 0)
                            o(p.length + h[l], d);
                          else if ("string" == typeof h[l])
                            for (c = 0, f = p.length; c < f; c++)
                              ("_all" == h[l] || e(p[c].nTh).hasClass(h[l])) &&
                                o(c, d);
                      }
                  ...
                  function z(t, n, a, o) {
                    ...
                    for (var u = t.aoColumns, c = 0, f = u.length; c < f; c++)
                      u[c].sType = null;
                    t.aiDisplayMaster.push(i);
                    var d = t.rowIdFn(n);
                    return (
                      d !== r && (t.aIds[d] = s),
                      (!a && t.oFeatures.bDeferRender) || ue(t, i, a, o),
                      i
                    );
                  }
                  function J(t, n) {
                  ...
                  function Q(e, t, n, a) {
                    ...
                    var o = e.iDraw,
                      ...
                      s = e.aoData[t]._aData,
                      u = i.sDefaultContent,
                      c = i.fnGetData(s, a, { settings: e, row: t, col: n });
                    if (c === r)
                      return (
                        e.iDrawError != o &&
                          null === u &&
                  ...
                  function Z(e, t, n, r) {
                    var a = e.aoColumns[n],
                      o = e.aoData[t]._aData;
                    a.fnSetData(o, r, { settings: e, row: t, col: n });
                  }
                  var K = /\[.*?\]$/,
                    ee = /\(\)$/;
                  function te(t) {
                  ...
                  function ie(e, t, n) {
                    for (var a = -1, o = 0, i = e.length; o < i; o++)
                      e[o] == t ? (a = o) : e[o] > t && e[o]--;
                    -1 != a && n === r && e.splice(a, 1);
                  }
                  function se(e, t, n, a) {
                    var o,
                      i,
                  ...
                  function le(e, t, n, a) {
                        ...
                        (n !== r && n !== c) ||
                          ...
                          i && i._bAttrSrc
                            ? (re(i.mData._)(a, s),
                              ...
                              p(i.mData.filter, e))
                            : d
                            ? (i._setter || (i._setter = re(i.mData)),
                              i._setter(a, s))
                            : (a[c] = s));
                        c++;
                      };
                    if (u)
                      ...
                      for (var g = 0, v = (l = t.anCells).length; g < v; g++)
                        h(l[g]);
                    ...
                    if (null === d.nTr) {
                      for (
                        ...
                        (l = t.aoColumns[u]),
                          ...
                          (!f &&
                            ((!l.mRender && l.mData === u) ||
                              (e.isPlainObject(l.mData) &&
                                l.mData._ === u + ".display"))) ||
                            (s.innerHTML = Q(t, r, u, "display")),
                          l.sClass && (s.className += " " + l.sClass),
                          l.bVisible && !a
                            ? i.appendChild(s)
                            : !l.bVisible && a && s.parentNode.removeChild(s),
                          l.fnCreatedCell &&
                  ...
                  function ce(t, n) {
                    ...
                    if (r) {
                      ...
                      if ((o && (r.id = o), a.DT_RowClass)) {
                        ...
                        (n.__rowc = n.__rowc ? A(n.__rowc.concat(i)) : i),
                          e(r)
                  ...
                  function fe(t) {
                    var n,
                      ...
                      f = t.aoColumns;
                    for (
                      u && (o = e("<tr/>").appendTo(s)), n = 0, r = f.length;
                      n < r;
                      n++
                    )
                      (i = f[n]),
                        ...
                        t.oFeatures.bSort &&
                          ...
                          !1 !== i.bSortable &&
                            ...
                            st(t, i.nTh, n))),
                        i.sTitle != a[0].innerHTML && a.php(i.sTitle),
                        St(t, "header")(t, a, i, c);
                    if (
                      (u && ve(t.aoHeader, s),
                      e(s)
                  ...
                  function de(t, n, a) {
                    ...
                    if (n) {
                      for (
                        a === r && (a = !1), o = 0, i = n.length;
                        o < i;
                        o++
                      ) {
                        for (
                          h[o] = n[o].slice(), h[o].nTr = n[o].nTr, s = v - 1;
                          s >= 0;
                          s--
                        )
                          t.aoColumns[s].bVisible || a || h[o].splice(s, 1);
                        g.push([]);
                      }
                      for (o = 0, i = h.length; o < i; o++) {
                        ...
                        for (s = 0, l = h[o].length; s < l; s++)
                          if (((d = 1), (p = 1), g[o][s] === r)) {
                            for (
                              f.appendChild(h[o][s].cell), g[o][s] = 1;
                              h[o + d] !== r &&
                              h[o][s].cell == h[o + d][s].cell;
                  ...
                  function pe(t, n) {
                    ...
                    if (-1 === e.inArray(!1, r)) {
                      ...
                      if (((t.bDrawing = !0), t.bDeferLoading))
                        (t.bDeferLoading = !1), t.iDraw++, Ve(t, !1);
                      else if (u) {
                        if (!t.bDestroying && !n) return void xe(t);
                      } else t.iDraw++;
                      if (0 !== c.length)
                        for (
                          var p = u ? 0 : f, h = u ? t.aoData.length : d, g = p;
                          g < h;
                          g++
                        ) {
                          var v = c[g],
                          ...
                          if (0 !== s) {
                            var b = i[o % s];
                            m._sRowStripe != b &&
                              (e(y).removeClass(m._sRowStripe).addClass(b),
                              (m._sRowStripe = b));
                          }
                          bt(t, "aoRowCallback", null, [y, m._aData, o, g, v]),
                            a.push(y),
                            o++;
                        }
                      else {
                  ...
                  function ge(t) {
                    ...
                    for (
                      var s, u, c, f, d, p, h = t.sDom.split(""), g = 0;
                      g < h.length;
                      g++
                    ) {
                      if (((s = null), "<" == (u = h[g]))) {
                        ...
                        for (
                          var m = l.ext.feature, y = 0, b = m.length;
                          y < b;
                          y++
                        )
                          if (u == m[y].cFeature) {
                  ...
                  function ve(t, n) {
                    ...
                    for (t.splice(0, t.length), o = 0, l = h.length; o < l; o++)
                      t.push([]);
                    for (o = 0, l = h.length; o < l; o++)
                      for (c = 0, a = (r = h[o]).firstChild; a; ) {
                        if (
                          ...
                          for (
                            f =
                              (f = 1 * a.getAttribute("colspan")) &&
                              0 !== f &&
                              1 !== f
                                ? f
                                : 1,
                              d =
                                (d = 1 * a.getAttribute("rowspan")) &&
                                0 !== d &&
                                1 !== d
                                  ? d
                                  : 1,
                  ...
                  function be(t, n, r) {
                    if (
                      (bt(t, "aoServerParams", "serverParams", [n]),
                      n && Array.isArray(n))
                    ) {
                      var a = {},
                        o = /(.*?)\[\]$/;
                    ...
                    var f = {
                      ...
                      error: function (n, r, a) {
                        var o = bt(t, null, "xhr", [t, null, t.jqXHR]);
                        -1 === e.inArray(!0, o) &&
                          ("parsererror" == r
                            ? ht(t, 0, "Invalid JSON response", 1)
                            : 4 === n.readyState && ht(t, 0, "Ajax error", 7)),
                          Ve(t, !1);
                      },
                    };
                    (t.oAjaxData = n),
                      bt(t, null, "preXhr", [t, n]),
                      t.fnServerData
                        ? t.fnServerData.call(
                            l,
                            t.sAjaxSource,
                        ...
                        ? (t.jqXHR = e.ajax(
                            e.extend(f, { url: s || t.sAjaxSource })
                          ))
                        : "function" == typeof s
                        ? (t.jqXHR = s.call(l, n, u, t))
                        : ((t.jqXHR = e.ajax(e.extend(f, s))), (s.data = i));
                  }
                  function xe(e) {
                    e.iDraw++,
                      Ve(e, !0),
                      be(e, Se(e), function (t) {
                        we(e, t);
                      });
                  }
                  function Se(t) {
                    var n,
                      ...
                      v = function (e, t) {
                        d.push({ name: e, value: t });
                      };
                    v("sEcho", t.iDraw),
                      v("iColumns", s),
                      v("sColumns", S(i, "sName").join(",")),
                      v("iDisplayStart", h),
                      v("iDisplayLength", g);
                    var m = {
                      draw: t.iDraw,
                    ...
                    for (n = 0; n < s; n++)
                      (a = i[n]),
                        (o = f[n]),
                        (r =
                          "function" == typeof a.mData ? "function" : a.mData),
                        m.columns.push({
                          data: r,
                          name: a.sName,
                    ...
                    u.bFilter &&
                      (v("sSearch", c.sSearch), v("bRegex", c.bRegex)),
                      u.bSort &&
                        (e.each(p, function (e, t) {
                          m.order.push({ column: t.col, dir: t.dir }),
                            v("iSortCol_" + e, t.col),
                            v("sSortDir_" + e, t.dir);
                        }),
                  ...
                  function Te(t) {
                    var r = t.oClasses,
                      ...
                      s = t.aanFeatures,
                      l =
                        '<input type="search" class="' + r.sFilterInput + '"/>',
                      u = o.sSearch;
                  ...
                  function _e(t) {
                    for (
                      ...
                      for (var u = [], c = 0, f = o.length; c < f; c++)
                        (r = o[c]),
                          (n = t.aoData[r]),
                          a[i](t, n._aFilterData, r, n._aData, c) && u.push(r);
                  ...
                  function Ie(e, t, n, r, a, o) {
                    ...
                    if (
                      ...
                      for (
                        ...
                        c.test(e.aoData[i[u]]._sFilterRow) && p.push(i[u]);
                      e.aiDisplay = p;
                    }
                  }
                  function Le(t, n, r, a) {
                  ...
                  function Ee(e) {
                    ...
                    for (t = 0, r = e.aoData.length; t < r; t++)
                      if (!(s = e.aoData[t])._aFilterData) {
                        for (o = [], n = 0, a = l.length; n < a; n++)
                          l[n].bSearchable
                            ? (null === (i = Q(e, t, n, "filter")) && (i = ""),
                              "string" != typeof i &&
                                i.toString &&
                                (i = i.toString()))
                            : (i = ""),
                            i.indexOf &&
                              -1 !== i.indexOf("&") &&
                              ((ke.innerHTML = i),
                              (i = Ne ? ke.textContent : ke.innerText)),
                            i.replace && (i = i.replace(/[\r\n\u2028]/g, "")),
                            o.push(i);
                        (s._aFilterData = o),
                          (s._sFilterRow = o.join("  ")),
                          (u = !0);
                      }
                    return u;
                  }
                  ...
                  function He(t) {
                    ...
                    if (0 !== n.length) {
                      ...
                      s !== i && (l += " " + r.sInfoFiltered),
                        (l = Oe(t, (l += r.sInfoPostFix)));
                      var u = r.fnInfoCallback;
                      null !== u && (l = u.call(t.oInstance, t, a, o, i, s, l)),
                        e(n).php(l);
                    }
                  }
                  function Oe(e, t) {
                    ...
                    return t
                      ...
                      .replace(/_PAGE_/g, n.call(e, i ? 1 : Math.ceil(r / a)))
                      .replace(/_PAGES_/g, n.call(e, i ? 1 : Math.ceil(o / a)));
                  }
                  function Me(e) {
                    var t,
                      n,
                    ...
                    if (e.bInitialised) {
                      for (
                        ...
                        (r = o[t]).sWidth && (r.nTh.style.width = nt(r.sWidth));
                  ...
                  function qe(e, t) {
                    (e._bInitComplete = !0),
                      (t || e.oInit.aaData) && q(e),
                      bt(e, null, "plugin-init", [e, t]),
                      bt(e, "aoInitComplete", "init", [e, t]);
                  }
                  function We(e, t) {
                    var n = parseInt(t, 10);
                    (e._iDisplayLength = n),
                      xt(e),
                      bt(e, null, "length", [e, n]);
                  }
                  function Be(t) {
                    for (
                      var n = t.oClasses,
                      ...
                      l[0][u] = new Option(
                        "number" == typeof s[u] ? t.fnFormatNumber(s[u]) : s[u],
                        i[u]
                      );
                    var f = e("<div><label/></div>").addClass(n.sLength);
                    return (
                      t.aanFeatures.l || (f[0].id = r + "_length"),
                      f
                        .children()
                        .append(
                          t.oLanguage.sLengthMenu.replace(
                            "_MENU_",
                            l[0].outerHTML
                          )
                        ),
                          ...
                          fn: function (e) {
                            if (a) {
                              var t,
                                ...
                                d = c ? 1 : Math.ceil(u / l),
                                p = r(f, d);
                              for (t = 0, n = s.p.length; t < n; t++)
                                St(e, "pageButton")(e, s.p[t], t, p, f, d);
                            } else r.fnUpdate(e, o);
                          },
                          sName: "pagination",
                        })),
                  ...
                  function $e(e, t, n) {
                    ...
                    0 === o || -1 === a
                      ...
                      : ht(e, 0, "Unknown paging action: " + t, 5);
                    var i = e._iDisplayStart !== r;
                    return (
                      (e._iDisplayStart = r),
                      i && (bt(e, null, "page", [e]), n && pe(e)),
                      i
                    );
                  }
                  function Xe(t) {
                  ...
                  function ze(t) {
                    ...
                    f.length || (f = null);
                    var h = e(d, { class: i.sScrollWrapper })
                      .append(
                        e(d, { class: i.sScrollHead })
                          .css({
                            overflow: "hidden",
                            position: "relative",
                            border: 0,
                    ...
                    f &&
                      h.append(
                        e(d, { class: i.sScrollFoot })
                          ...
                          .append(
                            e(d, { class: i.sScrollFootInner }).append(
                              c
                                .removeAttr("id")
                                .css("margin-left", 0)
                    ...
                    return (
                      a &&
                        e(m).on("scroll.DT", function (e) {
                          var t = this.scrollLeft;
                          (v.scrollLeft = t), f && (y.scrollLeft = t);
                        }),
                      e(m).css("max-height", o),
                      r.bCollapse || e(m).css("height", o),
                      (t.nScrollHead = v),
                      (t.nScrollBody = m),
                      (t.nScrollFoot = y),
                      t.aoDrawCallback.push({ fn: Je, sName: "scrolling" }),
                      h[0]
                    );
                  }
                  function Je(n) {
                    ...
                    if (n.scrollBarVis !== U && n.scrollBarVis !== r)
                      return (n.scrollBarVis = U), void q(n);
                    (n.scrollBarVis = U),
                      j.children("thead, tfoot").remove(),
                      E &&
                        ((u = E.clone().prependTo(j)),
                        (o = E.find("tr")),
                        (s = u.find("tr"))),
                      (l = L.clone().prependTo(j)),
                      (a = L.find("tr")),
                      (i = l.find("tr")),
                      l.find("th, td").removeAttr("tabindex"),
                      h || ((_.width = "100%"), (y[0].style.width = "100%")),
                      e.each(me(n, l), function (e, t) {
                      ...
                      "" === h
                        ? ((N.width = "100%"),
                          P &&
                            (j.find("tbody").height() > T.offsetHeight ||
                              "scroll" == C.css("overflow-y")) &&
                            (N.width = nt(j.outerWidth() - m)),
                          (d = j.outerWidth()))
                        : "" !== g && ((N.width = nt(g)), (d = j.outerWidth())),
                      Ge(B, i),
                      Ge(function (n) {
                        var r = t.getComputedStyle
                          ? t.getComputedStyle(n).width
                          : nt(e(n).width());
                      ...
                      Ge(function (e, t) {
                        (e.innerHTML =
                          '<div class="dataTables_sizing">' + O[t] + "</div>"),
                      ...
                      Math.round(j.outerWidth()) < Math.round(d)
                        ? ((f =
                          ...
                          P &&
                            ...
                            (N.width = nt(f - m)),
                          ("" !== h && "" === g) ||
                            ht(n, 1, "Possible column misalignment", 6))
                        : (f = "100%"),
                      (_.width = nt(f)),
                      (b.width = nt(f)),
                      E && (n.nScrollFoot.style.width = nt(f)),
                      v || (P && (_.height = nt(k.offsetHeight + m)));
                    var $ = j.outerWidth();
                    (D[0].style.width = nt($)), (w.width = nt($));
                    var X =
                        j.height() > T.clientHeight ||
                        "scroll" == C.css("overflow-y"),
                  ...
                  function Ge(e, t, n) {
                    for (var r, a, o = 0, i = 0, s = t.length; i < s; ) {
                      for (
                        r = t[i].firstChild, a = n ? n[i].firstChild : null;
                        r;

                      )
                        1 === r.nodeType && (n ? e(r, a, o) : e(r, o), o++),
                          (r = r.nextSibling),
                  ...
                  function Qe(n) {
                    var r,
                      ...
                      x = i.style.width;
                    for (
                      x && -1 !== x.indexOf("%") && (g = x), r = 0;
                      r < p.length;
                      r++
                    )
                      null !== (a = s[p[r]]).sWidth &&
                        ((a.sWidth = Ke(a.sWidthOrig, v)), (m = !0));
                    if (b || (!m && !c && !u && d == U(n) && d == h.length))
                      ...
                      for (
                        w.find("thead, tfoot").remove(),
                          w
                            .append(e(n.nTHead).clone())
                            .append(e(n.nTFoot).clone()),
                          w.find("tfoot th, tfoot td").css("width", ""),
                          h = me(n, w.find("thead")[0]),
                          r = 0;
                        r < p.length;
                        r++
                      )
                    ...
                    if (
                      (g && (i.style.width = nt(g)), (g || c) && !n._reszEvt)
                    ) {
                      var L = function () {
                        e(t).on(
                  ...
                  function et(t, n) {
                    ...
                    return a.nTr
                      ? a.anCells[n]
                      : e("<td/>").php(Q(t, r, n, "display"))[0];
                  }
                  function tt(e, t) {
                    for (
                      var n, r = -1, a = -1, o = 0, i = e.aoData.length;
                      o < i;
                      o++
                    )
                      (n = (n = (n = Q(e, o, t, "display") + "").replace(
                        Ye,
                        ""
                      )).replace(/&nbsp;/g, " ")).length > r &&
                        ((r = n.length), (a = o));
                  ...
                  function rt(t) {
                    ...
                    for (
                      ...
                      for (
                        ...
                        (u = d[(s = i[a])].sType || "string"),
                          g[n]._idx === r &&
                            (g[n]._idx = e.inArray(g[n][1], d[s].asSorting)),
                          f.push({
                            src: c,
                            col: s,
                            dir: g[n][1],
                  ...
                  function at(e) {
                    var t,
                      ...
                      c = (e.aoColumns, 0),
                      f = e.aiDisplayMaster;
                    for (X(e), t = 0, n = (o = rt(e)).length; t < n; t++)
                      (a = o[t]).formatter && c++, ut(e, a.col);
                    ...
                    if (
                      ...
                      l.length && l[0][0] == n
                        ? ((i = c(l[0])),
                          ...
                          (l[0][1] = u[i]),
                          (l[0]._idx = i))
                        : ((l.length = 0), l.push([n, u[0]]), (l[0]._idx = 0));
                  ...
                  function lt(t) {
                    ...
                    if (l.bSort && l.bSortClasses) {
                      for (n = 0, r = o.length; n < r; n++)
                        (a = o[n].src),
                          e(S(t.aoData, "anCells", a)).removeClass(
                            i + (n < 2 ? n + 1 : 3)
                          );
                      for (n = 0, r = s.length; n < r; n++)
                        (a = s[n].src),
                          e(S(t.aoData, "anCells", a)).addClass(
                            i + (n < 2 ? n + 1 : 3)
                          );
                    }
                    t.aLastSort = s;
                  ...
                  function ut(e, t) {
                    ...
                    for (
                      var s = l.ext.type.order[o.sType + "-pre"],
                        u = 0,
                        c = e.aoData.length;
                      u < c;
                      u++
                    )
                      (r = e.aoData[u])._aSortData || (r._aSortData = []),
                        (r._aSortData[t] && !i) ||
                          ((a = i ? n[u] : Q(e, u, t, "sort")),
                  ...
                  function ct(t) {
                    if (!t._bLoadingState) {
                      ...
                      (t.oSavedState = n),
                        bt(t, "aoStateSaveParams", "stateSaveParams", [t, n]),
                  ...
                  function dt(t, n, a) {
                    ...
                    var c = bt(t, "aoStateLoadParams", "stateLoadParams", [
                      t,
                      n,
                    ]);
                    if (-1 !== e.inArray(!1, c))
                      return (t._bLoadingState = !1), void a();
                    ...
                    if (
                      ...
                      n.search !== r &&
                        e.extend(t.oPreviousSearch, Pe(n.search)),
                      n.columns)
                    ) {
                      for (o = 0, i = n.columns.length; o < i; o++) {
                        ...
                        d.visible !== r &&
                          (u
                            ...
                            : (s[o].bVisible = d.visible)),
                          d.search !== r &&
                            e.extend(t.aoPreSearchCols[o], Pe(d.search));
                      }
                      u && u.columns.adjust();
                    }
                    (t._bLoadingState = !1),
                      bt(t, "aoStateLoaded", "stateLoaded", [t, n]),
                      a();
                  }
                  function pt(t) {
                    var n = l.settings,
                  ...
                  function ht(e, n, r, a) {
                    if (
                      ...
                      if ((e && bt(e, null, "error", [e, a, r]), "alert" == i))
                        alert(r);
                      else {
                    ...
                    e.extend(o.prototype, {
                      ...
                      iterator: function (e, t, n, a) {
                        ...
                        for (
                          ...
                          var m = new o(g[s]);
                          if ("table" === t)
                            (i = n.call(m, g[s], s)) !== r && h.push(i);
                          else if ("columns" === t || "rows" === t)
                            (i = n.call(m, g[s], this[s], s)) !== r &&
                              h.push(i);
                          else if (
                            "column" === t ||
                            "column-rows" === t ||
                            ...
                            for (
                              ...
                              (p = d[u]),
                                (i =
                                  "cell" === t
                                    ? n.call(m, g[s], p.row, p.column, s, u)
                                    : n.call(m, g[s], p, s, u, f)) !== r &&
                                  h.push(i);
                        }
                        if (h.length || a) {
                  ...
                  var It = function (e, t, n, o, i) {
                      ...
                      for (
                        ...
                        for (
                          ...
                          (s = n(
                            "string" == typeof l[f] ? l[f].trim() : l[f]
                          )) &&
                            s.length &&
                            (p = p.concat(s));
                      var g = a.selector[e];
                    ...
                    kt = function (t, n) {
                      var r,
                        ...
                        u = n.page;
                      if ("ssp" == wt(t))
                        return "removed" === s ? [] : D(0, i.length);
                      if ("current" == u)
                        for (
                          f = t._iDisplayStart, d = t.fnDisplayEnd();
                          f < d;
                          f++
                        )
                          a.push(o[f]);
                        ...
                        for (f = 0, d = t.aoData.length; f < d; f++)
                          ("none" == s ||
                            (-1 === (r = e.inArray(f, o)) && "removed" == s) ||
                            (r >= 0 && "applied" == s)) &&
                            a.push(f);
                      return a;
                    },
                  ...
                  i("rows()", function (t, n) {
                    ...
                    i("row().node()", function () {
                      var e = this.context;
                      return (
                        (e.length && this.length && e[0].aoData[this[0]].nTr) ||
                        null
                      );
                    }),
                    ...
                    e(n).on("plugin-init.dt", function (t, n) {
                      ...
                      r.on("stateSaveParams", function (e, t, n) {
                        for (
                          var r = t.rowIdFn, a = t.aoData, o = [], i = 0;
                          i < a.length;
                          i++
                        )
                      ...
                      var o = [],
                        i = function (n, r) {
                          if (Array.isArray(n) || n instanceof e)
                            ...
                            (e("td", l).addClass(r).php(n)[0].colSpan = U(t)),
                              o.push(l[0]);
                          }
                        };
                      i(r, a),
                    ...
                    Pt = function (t, n) {
                      ...
                      if (a.length) {
                        ...
                        o &&
                          ...
                          (o._detailsShow = r),
                          (o._details = r),
                          e(o.nTr).removeClass("dt-hasChild"),
                          Ft(a));
                      }
                    },
                    Rt = function (t, n) {
                      ...
                      if (r.length && t.length) {
                        ...
                        a._details &&
                          ...
                          bt(r[0], null, "childRow", [n, t.row(t[0])]),
                          Ht(r[0]),
                          Ft(r));
                      }
                    },
                              ...
                              de(o, o.aoHeader),
                                ...
                                o.aiDisplay.length ||
                                  e(o.nTBody)
                                    ...
                                    .attr("colspan", U(o)),
                                ct(o),
                                a.iterator("column", function (e, r) {
                                  bt(e, null, "column-visibility", [
                                    e,
                                    r,
                                    t,
                                    n,
                    ...
                    return It(
                      ...
                      function (n) {
                        ...
                        var h = g
                          ...
                          .toArray();
                        return h.length || !n.nodeName
                          ? h
                          : (f = e(n).closest("*[data-dt-row]")).length
                          ? [
                              {
                                row: f.data("dt-row"),
                  ...
                  i("cells()", function (t, n, a) {
                      ...
                      d = this.iterator(
                        ...
                        function (e, t) {
                          ...
                          for (o = 0, i = f[t].length; o < i; o++)
                            for (s = 0, l = c[t].length; s < l; s++)
                              n.push({ row: f[t][o], column: c[t][s] });
                          return n;
                        },
                        1
                      ),
                    ...
                    return (
                      e.extend(p.selector, { cols: n, rows: t, opts: a }), p
                    );
                  }),
                    ...
                    s("cells().indexes()", "cell().index()", function () {
                      return this.iterator(
                        "cell",
                        function (e, t, n) {
                          return { row: t, column: n, columnVisible: B(e, n) };
                        },
                        1
                      );
                    }),
                    ...
                    i("cell().data()", function (e) {
                      ...
                      return e === r
                        ? t.length && n.length
                          ? Q(t[0], n[0].row, n[0].column)
                          : r
                        : (Z(t[0], n[0].row, n[0].column, e),
                          se(t[0], n[0].row, "data", n[0].column),
                          this);
                    }),
                    ...
                    (l.isDataTable = l.fnIsDataTable =
                      function (t) {
                        ...
                        return (
                          t instanceof l.Api ||
                          (e.each(l.settings, function (t, a) {
                            var o = a.nScrollHead
                                ? e("table", a.nScrollHead)[0]
                                : null,
                              i = a.nScrollFoot
                                ? e("table", a.nScrollFoot)[0]
                                : null;
                    ...
                    i("$()", function (t, n) {
                      var r = this.rows(n).nodes(),
                        a = e(r);
                      return e(
                        [].concat(a.filter(t).toArray(), a.find(t).toArray())
                      );
                    }),
                    ...
                    i("destroy()", function (n) {
                      return (
                        ...
                        this.iterator("table", function (r) {
                          ...
                          (r.bDestroying = !0),
                            bt(r, "aoDestroyCallback", "destroy", [r]),
                            n || new o(r).columns().visible(!0),
                            g.off(".DT").find(":not(tbody *)").off(".DT"),
                            e(t).off(".DT-" + r.sInstance),
                            u != f.parentNode &&
                              (p.children("thead").detach(), p.append(f)),
                            d &&
                              u != d.parentNode &&
                              (p.children("tfoot").detach(), p.append(d)),
                            (r.aaSorting = []),
                            (r.aaSortingFixed = []),
                            lt(r),
                            e(v).removeClass(r.asStripeClasses.join(" ")),
                            e("th, td", f).removeClass(
                              s.sSortable +
                                " " +
                                s.sSortableAsc +
                                " " +
                          ...
                          p[m](),
                            ...
                            !n &&
                              i &&
                              (i.insertBefore(u, r.nTableReinsertBefore),
                              p
                  ...
                  function Vt(e, t) {
                    ...
                    return (
                      t <= r
                        ? (n = D(0, t))
                        : e <= a
                        ? ((n = D(0, r - 2)).push("ellipsis"), n.push(t - 1))
                        : e >= t - 1 - a
                        ? ((n = D(t - (r - 2), t)).splice(0, 0, "ellipsis"),
                          n.splice(0, 0, 0))
                        : ((n = D(e - a + 2, e + a - 1)).push("ellipsis"),
                          n.push(t - 1),
                  ...
                  e.extend(Xt, {
                                ...
                                if (((f = r[a]), Array.isArray(f))) {
                                  ...
                                  switch (
                                    ...
                                    case "last":
                                      ...
                                      break;
                                    default:
                                      (u = t.fnFormatNumber(f + 1)),
                                        (c =
                                          s === f ? d.sPageButtonActive : "");
                                  }
                                  null !== u &&
                                    (mt(
                                      e("<a>", {
                    ...
                    e.extend(l.ext.type.detect, [
                      function (e, t) {
                        var n = t.oLanguage.sDecimal;
                        return y(e, n) ? "num" + n : null;
                      },
                      function (e, t) {
                        if (e && !(e instanceof Date) && !d.test(e))
                          return null;
                        var n = Date.parse(e);
                        return (null !== n && !isNaN(n)) || g(e)
                          ? "date"
                          : null;
                      },
                      function (e, t) {
                  ...
                  function Jt(t) {
                    e.each(
                      ...
                      function (e, n) {
                        (a.type.order[e + t + "-pre"] = n),
                          e.match(/^html\-/) &&
                            (a.type.search[e + t] = a.type.search.php);
                      }
                    );
                  }
                  ...
                  function Yt(e) {
                    return function () {
                      var t = [pt(this[l.ext.iApiIndex])].concat(
      ...
      9755: function (e, t) {
        ...
        !(function (t, n) {
                    ...
                    for (t in e)
                      (r = e[t]),
                        "__proto__" !== t &&
                          ...
                          (u &&
                          r &&
                          (T.isPlainObject(r) || (a = Array.isArray(r)))
                            ? ((n = i[t]),
                              (o =
                                a && !Array.isArray(n)
                                  ? []
          ...
          var _ = (function (e) {
            ...
            try {
              E.apply((j = F.call(S.childNodes)), S.childNodes),
                ...
                return i != p && 9 === i.nodeType && i.documentElement
                  ? ((h = (p = i).documentElement),
                    ...
                    S != p &&
                      ...
                      a.top !== a &&
                      (a.addEventListener
                        ? a.addEventListener("unload", oe, !1)
                        : a.attachEvent && a.attachEvent("onunload", oe)),
            ...
            (se.attr = function (e, t) {
              ...
              var a = r.attrHandle[t.toLowerCase()],
                o =
                  a && L.call(r.attrHandle, t.toLowerCase())
                    ? a(e, t, !g)
                    : void 0;
              return void 0 !== o
                ? o
                    ...
                    return a[x]
                      ...
                      ? ((n = [e, e, "", t]),
                        r.setFilters.hasOwnProperty(e.toLowerCase())
                          ? ue(function (e, n) {
                              for (var r, o = a(e, t), i = o.length; i--; )
                                e[(r = P(e, o[i]))] = !(n[r] = o[i]);
                            })
                          : function (e) {
                              return a(e, 0, n);
            ...
            function we(e, t, n, r, a) {
              for (
                var o, i = [], s = 0, l = e.length, u = null != t;
                s < l;
                s++
              )
                (o = e[s]) &&
                  ((n && !n(o, r, a)) || (i.push(o), u && t.push(s)));
              return i;
            }
              ...
              return (
                ...
                ue(function (o, i, s, l) {
                  var u,
                    ...
                    m = n ? (a || (o ? e : h || r) ? [] : i) : v;
                  if ((n && n(v, m, s, l), r))
                    for (u = we(m, p), r(u, [], s, l), c = u.length; c--; )
                      (f = u[c]) && (m[p[c]] = !(v[p[c]] = f));
                  if (o) {
                    if (a || e) {
                      if (a) {
              ...
              (i = se.tokenize =
                function (e, t) {
                  ...
                  for (s = e, l = [], u = r.preFilter; s; ) {
                    for (i in ((n && !(a = U.exec(s))) ||
                      (a && (s = s.slice(a[0].length) || s), l.push((o = []))),
                    (n = !1),
                    (a = $.exec(s)) &&
                      ((n = a.shift()),
                      o.push({ value: n, type: a[0].replace(B, " ") }),
                      (s = s.slice(n.length))),
                    r.filter))
                      !(a = J[i].exec(s)) ||
                        (u[i] && !(a = u[i](a))) ||
                        ((n = a.shift()),
                        o.push({ value: n, type: i, matches: a }),
                        (s = s.slice(n.length)));
                    if (!n) break;
                  }
                  ...
                  if (((n = n || []), 1 === p.length)) {
                    ...
                    for (
                      ...
                      if (
                        ...
                        if ((l.splice(o, 1), !(e = a.length && be(l))))
                          return E.apply(n, a), n;
                        break;
                      }
                  }
                  return (
            ...
            T.each(
              ...
              function (e, t) {
                T.fn[e] = function (n, r) {
                  ...
                  return (
                    "Until" !== e.slice(-5) && (r = n),
                    r && "string" == typeof r && (a = T.filter(r, a)),
                    this.length > 1 &&
                      (R[e] || T.uniqueSort(a), P.test(e) && a.reverse()),
                    this.pushStack(a)
                  );
                };
              }
                  ...
                  a = {
                    ...
                    then: function (e, n, a) {
                            ...
                            u = function () {
                              ...
                              if (!(e < o)) {
                                ...
                                (u =
                                  ...
                                  m(u)
                                    ? a
                                      ? u.call(r, i(o, t, M, a), i(o, t, q, a))
                                      : (o++,
                                        u.call(
                                          r,
                                          i(o, t, M, a),
                                          i(o, t, q, a),
                                          i(o, t, M, t.notifyWith)
                                        ))
                                    : (n !== M && ((s = void 0), (l = [r])),
                                      (a || t.resolveWith)(s, l));
                              }
                      ...
                      return T.Deferred(function (r) {
                        t[0][3].add(i(0, r, m(a) ? a : M, r.notifyWith)),
                          t[1][3].add(i(0, r, m(e) ? e : M)),
                          t[2][3].add(i(0, r, m(n) ? n : q));
                      }).promise();
                    },
                    promise: function (e) {
              ...
              when: function (e) {
                var t = arguments.length,
                  ...
                  i = function (e) {
                    return function (n) {
                      (r[e] = this),
                        (a[e] = arguments.length > 1 ? s.call(arguments) : n),
                        --t || o.resolveWith(r, a);
                    };
                  };
                if (
                  t <= 1 &&
                  (W(e, o.done(i(n)).resolve, o.reject, !t),
                  "pending" === o.state() || m(a[n] && a[n].then))
                )
                  return o.then();
          ...
          function pe(e, t) {
            for (var n, r, a = [], o = 0, i = e.length; o < i; o++)
              (r = e[o]).style &&
                ...
                t
                  ? ("none" === n &&
                      ((a[o] = Z.get(r, "display") || null),
                      a[o] || (r.style.display = "")),
                    "" === r.style.display && ue(r) && (a[o] = de(r)))
                  : "none" !== n && ((a[o] = "none"), Z.set(r, "display", n)));
                ...
                if ("object" === w(o)) T.merge(d, o.nodeType ? [o] : o);
                  ...
                  for (
                    i = i || f.appendChild(t.createElement("div")),
                      ...
                      l = be[s] || be._default,
                      i.innerHTML = l[1] + T.phpPrefilter(o) + l[2],
                      c = l[0];
                    c--;

                  )
                    i = i.lastChild;
                  T.merge(d, i.childNodes),
            ...
            if (1 === t.nodeType) {
              if (Z.hasData(e) && (s = Z.get(e).events))
                for (a in (Z.remove(t, "handle events"), s))
                  for (n = 0, r = s[a].length; n < r; n++)
                    T.event.add(t, a, s[a][n]);
              K.hasData(e) &&
                ((o = K.access(e)), (i = T.extend({}, o)), K.set(t, i));
            }
          }
          function Me(e, t) {
            var n = t.nodeName.toLowerCase();
          ...
          function qe(e, t, n, r) {
            ...
            if (
              g ||
              (d > 1 && "string" == typeof h && !v.checkClone && Ee.test(h))
            )
              return e.each(function (a) {
                var o = e.eq(a);
                g && (t[0] = h.call(this, a, o.php())), qe(o, t, n, r);
              });
            if (
              d &&
              ((o = (a = De(t, e[0].ownerDocument, !1, e, r)).firstChild),
              1 === a.childNodes.length && (a = o),
              o || r)
            ) {
              for (s = (i = T.map(xe(a, "script"), Re)).length; f < d; f++)
                (u = a),
                  f !== p &&
                    ((u = T.clone(u, !0, !0)),
                    s && T.merge(i, xe(u, "script"))),
                  n.call(e[f], u, f);
              if (s)
                for (
                  c = i[i.length - 1].ownerDocument, T.map(i, He), f = 0;
                  f < s;
                  f++
                )
                  (u = i[f]),
                    ye.test(u.type || "") &&
                      ...
                      (u.src && "module" !== (u.type || "").toLowerCase()
                        ...
                        : S(u.textContent.replace(Fe, ""), u, c));
            }
            return e;
          }
          function We(e, t, n) {
            for (
              var r, a = t ? T.filter(t, e) : e, o = 0;
              null != (r = a[o]);
              o++
            )
              n || 1 !== r.nodeType || T.cleanData(xe(r)),
                r.parentNode &&
                  (n && se(r) && Se(xe(r, "script")),
          ...
          T.extend({
            ...
            clone: function (e, t, n) {
              ...
              if (
                ...
                for (i = xe(s), r = 0, a = (o = xe(e)).length; r < a; r++)
                  Me(o[r], i[r]);
              if (t)
                if (n)
                  for (
                    o = o || xe(e), i = i || xe(s), r = 0, a = o.length;
                    r < a;
                    r++
                  )
                    Oe(o[r], i[r]);
            ...
            cleanData: function (e) {
              for (
                var t, n, r, a = T.event.special, o = 0;
                void 0 !== (n = e[o]);
                o++
              )
                if (Y(n)) {
            ...
            T.each(
              ...
              function (e, t) {
                T.fn[e] = function (e) {
                  for (
                    var n, r = [], a = T(e), o = a.length - 1, i = 0;
                    i <= o;
                    i++
                  )
          ...
          function rt(e, t, n, r, a, o) {
            ...
            for (; i < 4; i += 2)
              "margin" === n && (l += T.css(e, n + oe[i], !0, a)),
                r
                  ? ("content" === n &&
                      (l -= T.css(e, "padding" + oe[i], !0, a)),
                    "margin" !== n &&
                      (l -= T.css(e, "border" + oe[i] + "Width", !0, a)))
                  : ((l += T.css(e, "padding" + oe[i], !0, a)),
                    "padding" !== n
                      ? (l += T.css(e, "border" + oe[i] + "Width", !0, a))
                      : (s += T.css(e, "border" + oe[i] + "Width", !0, a)));
            return (
              !r &&
                o >= 0 &&
                (l +=
          ...
          function at(e, t, n) {
            ...
            return (
              ((!v.boxSizingReliable() && a) ||
                ...
                (o = s in e) && (i = e[s])),
              (i = parseFloat(i) || 0) +
                rt(e, t, n || (a ? "border" : "content"), o, r, i) +
                "px"
            );
          }
              ...
              T.cssHooks[t] = {
                ...
                set: function (e, n, r) {
                  var a,
                    ...
                    s =
                      (i || r) && "border-box" === T.css(e, "boxSizing", !1, o),
                    l = r ? rt(e, t, r, s, o) : 0;
                  return (
                    s &&
                      i &&
                ...
                return X(
                  ...
                  function (e, t, n) {
                    var r,
                      ...
                      i = 0;
                    if (Array.isArray(t)) {
                      for (r = Ue(e), a = t.length; i < a; i++)
                        o[t[i]] = T.css(e, t[i], !1, r);
                      return o;
                    }
          ...
          function dt(e, t) {
            ...
            for (t = t ? 1 : 0; r < 4; r += 2 - t)
              a["margin" + (n = oe[r])] = a["padding" + n] = e;
            return t && (a.opacity = a.width = e), a;
          }
          function pt(e, t, n) {
            for (
              var r,
                a = (ht.tweeners[t] || []).concat(ht.tweeners["*"]),
                o = 0,
                i = a.length;
              o < i;
              o++
              ...
              !(function (e, t) {
                ...
                for (n in e)
                  if (
                    ...
                    for (n in ((o = i.expand(o)), delete e[r], o))
                ...
                return (
                  ...
                  this.each(function () {
                    ...
                    if (a) i[a] && i[a].stop && r(i[a]);
                      ...
                      for (a in i) i[a] && i[a].stop && ut.test(a) && r(i[a]);
                    for (a = o.length; a--; )
                      o[a].elem !== this ||
                        (null != e && o[a].queue !== e) ||
                ...
                if ((t = St(e)).length)
                  for (; (n = this[l++]); )
                    if (
                      ...
                      for (i = 0; (o = t[i++]); )
                        r.indexOf(" " + o + " ") < 0 && (r += o + " ");
                      a !== (s = bt(r)) && n.setAttribute("class", s);
                    }
                return this;
              },
              ...
              return arguments.length
                ? ((r = m(e)),
                  this.each(function (n) {
                    var a;
                    1 === this.nodeType &&
                      (null == (a = r ? e.call(this, n, T(this).val()) : e)
                        ? (a = "")
                        : "number" == typeof a
                        ? (a += "")
                        : Array.isArray(a) &&
                          (a = T.map(a, function (e) {
                            return null == e ? "" : e + "";
                          })),
                      ((t =
                ...
                ? (t =
                    T.valHooks[a.type] ||
                    T.valHooks[a.nodeName.toLowerCase()]) &&
                  "get" in t &&
            ...
            T.extend({
              valHooks: {
                ...
                select: {
                  ...
                  set: function (e, t) {
                    for (
                      var n, r, a = e.options, o = T.makeArray(t), i = a.length;
                      i--;
          ...
          T.extend(T.event, {
            trigger: function (e, t, n, a) {
              ...
              if (
                ...
                3 !== n.nodeType &&
                  8 !== n.nodeType &&
                  !Dt.test(g + T.event.triggered) &&
                  (g.indexOf(".") > -1 &&
                    ((v = g.split(".")), (g = v.shift()), v.sort()),
                  (u = g.indexOf(":") < 0 && "on" + g),
                  ((e = e[T.expando]
                    ? e
                    : new T.Event(g, "object" == typeof e && e)).isTrigger = a
                    ? 2
                    : 3),
                  (e.namespace = v.join(".")),
          ...
          function Nt(e, t, n, r) {
            ...
            else for (a in t) Nt(e + "[" + a + "]", t[a], n, r);
          }
          ...
          (Bt.href = Ct.href),
            T.extend({
              ...
              ajax: function (e, t) {
                ...
                p.hasContent
                  ...
                  : ((d = p.url.slice(a.length)),
                    p.data &&
                      ...
                      ((a += (At.test(a) ? "&" : "?") + p.data), delete p.data),
                    !1 === p.cache &&
                      ((a = a.replace(Pt, "$1")),
                      (d = (At.test(a) ? "&" : "?") + "_=" + _t.guid++ + d)),
                    (p.url = a + d)),
                p.ifModified &&
                  (T.lastModified[a] &&
                    D.setRequestHeader("If-Modified-Since", T.lastModified[a]),
                  T.etag[a] && D.setRequestHeader("If-None-Match", T.etag[a])),
                ((p.data && p.hasContent && !1 !== p.contentType) ||
                  t.contentType) &&
                  D.setRequestHeader("Content-Type", p.contentType),
                D.setRequestHeader(
                  "Accept",
                ...
                p.headers))
                  D.setRequestHeader(f, p.headers[f]);
                if (p.beforeSend && (!1 === p.beforeSend.call(h, D, p) || u))
                  return D.abort();
                if (
                  ((w = "abort"),
                  m.add(p.complete),
                  ...
                  if (
                    ((D.readyState = 1), c && g.trigger("ajaxSend", [D, p]), u)
                  )
                    return D;
                  p.async &&
                    p.timeout > 0 &&
                ...
                function C(e, t, i, l) {
                  ...
                  u ||
                    ...
                    i &&
                      (x = (function (e, t, n) {
                        for (
                          var r, a, o, i, s = e.contents, l = e.dataTypes;
                          "*" === l[0];
                    ...
                    f
                      ? (p.ifModified &&
                          ((S = D.getResponseHeader("Last-Modified")) &&
                            (T.lastModified[a] = S),
                          (S = D.getResponseHeader("etag")) && (T.etag[a] = S)),
                        204 === e || "HEAD" === p.type
                          ? (w = "nocontent")
                          : 304 === e
                          ? (w = "notmodified")
                    ...
                    (D.statusText = (t || w) + ""),
                    f
                      ? v.resolveWith(h, [d, w, D])
                      : v.rejectWith(h, [D, w, b]),
                    D.statusCode(y),
                    (y = void 0),
                    c &&
          ...
          T.ajaxSetup({
            ...
            jsonpCallback: function () {
              var e = Gt.pop() || T.expando + "_" + _t.guid++;
              return (this[e] = !0), e;
            },
          }),
            T.ajaxPrefilter("json jsonp", function (e, t, n) {
              ...
              if (s || "jsonp" === e.dataTypes[0])
                return (
                  ...
                  s
                    ? (e[s] = e[s].replace(Yt, "$1" + a))
                    : !1 !== e.jsonp &&
                      (e.url +=
                        (At.test(e.url) ? "&" : "?") + e.jsonp + "=" + a),
                  ...
                  n.always(function () {
                    void 0 === o ? T(r).removeProp(a) : (r[a] = o),
                      e[a] && ((e.jsonpCallback = t.jsonpCallback), Gt.push(a)),
                      i && m(o) && o(i[0]),
                      (i = o = void 0);
                  }),
                  "script"
                ...
                if (this[0]) {
                  ...
                  if ("fixed" === T.css(r, "position"))
                    ...
                    e &&
                      e !== r &&
                      1 === e.nodeType &&
                      (((a = T(e).offset()).top += T.css(
                        e,
                        "borderTopWidth",
                        !0
                      )),
                      (a.left += T.css(e, "borderLeftWidth", !0)));
                  }
                  return {
            ...
            T.each(["top", "left"], function (e, t) {
              T.cssHooks[t] = ze(v.pixelPosition, function (e, n) {
                if (n)
                  return (
                    (n = Ve(e, t)), Be.test(n) ? T(e).position()[t] + "px" : n
                  );
              });
            }),
