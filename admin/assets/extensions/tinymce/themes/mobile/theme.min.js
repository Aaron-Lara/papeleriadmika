...
!(function () {
    ...
    ze(n)
      ...
      : ((r = e),
        ...
        (i = E(Pe((o = n), "class"), function (n) {
          ...
          ? Ie(o, "class", i.join(" "))
          : He(o, "class")),
      0 === (ze((t = n)) ? t.dom.classList : Pe(t, "class")).length &&
        He(t, "class");
  }
  function $e(n, e) {
  ...
  var ni = w(lo(Sr())),
    ...
    ti = Ao({
      fields: [
        $t("channels", Nt(ht.value, It([Cr("onReceive"), Yt("schema", mo())]))),
      ],
      name: "receiving",
      active: pr,
    }),
  ...
  function _i(n, e, t, o) {
    Mi(n, e, 0, [o]),
      Bi(0, e, 0, o) ||
        (je(o.element, e.highlightClass), e.onHighlight(n, o), W(o, ce()));
  }
  function Ri(t, e, n, o) {
          ...
          $f.sketch({
            ...
            components: [
              ...
              $f.parts.spectrum({
                ...
                components: [
                  ka('<div class="${prefix}-slider-gradient"></div>'),
                ],
                behaviours: or([
  ...
  var Kl,
    ...
    wd = function (n, c) {
      var e,
        ...
        u,
        a = Me(n, function (r, u) {
          return (1 === r.length ? ht.value(r[0].handler) : gl(r, c, u)).map(
            function (n) {
              var e,
                i,
                t =
      ...
      factory: function (c, n) {
        ...
        function s(e, n, t) {
          M(u(n, n.otherMenus(t)), function (n) {
            hl(n.element, [c.markers.backgroundMenu]),
              c.stayInDom || jd.remove(e, n);
          });
        }
        function f(n, o) {
          var e;
      ...
      progressTo: function (t, o, r, i) {
        ...
        Xd(t, o, r, c).fold(
          ...
          function (n) {
            Dl(t, o, r);
            var e = n.transition;
            je(t.element, e.transitionClass),
              Ie(t.element, o.destinationAttr, i);
          }
        );
      },
      getState: function (n, e, t) {
  ...
  function mm(n) {
    ...
    return (
      ...
      (l = un(e, o) && t === r),
      f.collapsed && !l
        ? mn.some(fg(d, n.anchorOffset, m, n.focusOffset))
        : dm(n)
    );
  }
  function gm(n) {
      ...
      n = Pl(fe.fromDom(o), "resize", function () {
        ...
        (n = o),
          ...
          ((t = n.innerHeight) < e ? mn.some(e - t) : mn.none()).each(function (
            ...
            var n;
            (0 < (n = _m(r)).length ? mn.some(n[0]).map(Fm) : mn.none()).each(
              function (n) {
                var e =
        ...
        return (
          ...
          s.isStopped()
            ...
            : pe(e.element).fold(
                ...
                function (n) {
                  return (
                    i.logEventResponse(o, e.element, t.purpose), Bg.resume(n)
                  );
                }
              )
        );
  ...
  var cg,
    ...
    Dg = w([
      Lt("items"),
      Gt("markers", Z(["itemSelector"], Lt)),
      ju("tgroupBehaviours", [jc]),
    ]),
            ...
            y.set(
              ...
              (a = [
                ...
                Pl(t.doc, "touchend", function (n) {
                  un(t.php, n.target) || un(t.body, n.target);
                }),
