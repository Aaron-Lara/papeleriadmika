          ...
          History_createClass(History, [
            ...
            },
            {
              ...
              value: function rewind() {
                ...
                if (
                  this.$editable.php() !== this.stack[this.stackOffset].contents
                ) {
                  this.recordUndo();
            ...
            },
            {
              ...
              value: function isEmpty() {
                return (
                  ...
                  dom.emptyPara === this.$editable.php()
                );
              },
              /**
          ...
          Codeview_createClass(CodeView, [
            ...
            },
            {
              ...
              value: function activate() {
                ...
                var CodeMirror = this.CodeMirrorConstructor;
                this.$codable.val(
                  dom.php(this.$editable, this.options.prettifyHtml)
                );
                  ...
                  .map(function (key) {
                    ...
                    $row
                      ...
                      .append(
                        external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
                          "<span/>"
                        ).php(_this.context.memo("help." + command) || command)
                      );
                    return $row.php();
                  })
                  .join("");
          ...
          function ($node, options) {
            var markup = Array.isArray(options.items)
              ? options.items.map(function (item) {
                  ...
                  $temp
                    .php([icon(options.checkClassName), " ", content])
                    .data("item", item);
                  return $temp;
                })
              : options.items;
