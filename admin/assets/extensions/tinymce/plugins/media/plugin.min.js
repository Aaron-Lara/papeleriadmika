...
!(function () {
  ...
  var B = function (r) {
    ...
    V = tinymce.util.Tools.resolve("tinymce.php.SaxParser"),
    X = Q.DOM,
    Y = tinymce.util.Tools.resolve("tinymce.php.Schema"),
    Z = tinymce.util.Tools.resolve("tinymce.php.Writer"),
    ee = Q.DOM,
    te = ["source", "altsource"],
    re = [
      {
    ...
    ae = {},
    oe = tinymce.util.Tools.resolve("tinymce.php.Node"),
    ie = tinymce.util.Tools.resolve("tinymce.Env"),
    ce = tinymce.util.Tools.resolve("tinymce.php.DomParser"),
    se = function (e, t, r) {
