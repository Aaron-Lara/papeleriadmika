...
(function () {
  ...
  var doCreate = function (
    ...
    var me = __assign(__assign(__assign({}, wrappedExtra), wrappedApis), {
      ...
      exhibit: function (info, base) {
        return lift2(
          getConfig(info),
          get$c(active, "exhibit"),
          function (behaviourInfo, exhibitor) {
  ...
  var orientation = function (onReceive) {
    return Receiving.config({
      channels: wrap(orientationChanged, { onReceive: onReceive }),
    });
  };
  ...
  var getHighlighted = function (component, hConfig, _hState) {
    return descendant(component.element, "." + hConfig.highlightClass).bind(
      function (e) {
  ...
  var getFirst = function (component, hConfig, _hState) {
    return descendant(component.element, "." + hConfig.itemClass).bind(
      function (e) {
        return component.getSystem().getByDom(e).toOptional();
      }
    );
  ...
  var inside = function (target) {
    return (
      (name$1(target) === "input" && get$b(target, "type") !== "radio") ||
      name$1(target) === "textarea"
    );
  };
  ...
  var getKeydownRules$5 = function (
    component,
    _simulatedEvent,
    executeConfig,
    _executeState
  ...
  var horizontal = function (container, selector, current, delta) {
    var isDisabledButton = function (candidate) {
      return (
        name$1(candidate) === "button" &&
        get$b(candidate, "disabled") === "disabled"
      );
    };
  ...
  var doMove = function (ifCycle, ifMove) {
    return function (element, focused, matrixConfig) {
      ...
      return closest$1(focused, matrixConfig.selectors.row).bind(function (
        inRow
      ) {
  ...
  var makeApi = function (f) {
    return markAsSketchApi(function (component) {
      ...
      return f.apply(
        void 0,
        __spreadArray([component.getApis(), component], rest, false)
      );
    }, f);
  };
  ...
  var composite$1 = function (owner, schema, partTypes, factory, spec) {
    ...
    var detail = asRawOrDie(owner, schema, specWithUid, partSchemas, [
      partUidsSchema,
    ]);
  ...
  var supplyUid = function (spec) {
    return hasUid(spec)
      ? spec
      : __assign(__assign({}, spec), { uid: generate$2("uid") });
  };
  ...
  var handleMovement = function (direction, isVerticalMovement) {
    return function (spectrum, detail) {
      return moveBy(direction, isVerticalMovement, spectrum, detail).map(
        always
      );
    };
  };
  ...
  var record = function (spec) {
    var uid =
      isSketchSpec$1(spec) && hasNonNullableKey(spec, "uid")
        ? spec.uid
        : generate$2("memento");
  ...
  var hasNative = function (component, config) {
    return (
      ...
      contains$1(nativeDisabled, name$1(component.element))
    );
  };
  ...
  var sketch$3 = function (rawSpec) {
    ...
    var reposition = function (dialog, message) {
      descendant(dialog.element, "." + resolve("serialised-dialog-chain")).each(
        function (parent) {
          set$5(
            parent,
            "left",
        ...
        config(wrapperAdhocEvents, [
          run(touchstart(), function (_wrapper, simulatedEvent) {
            ...
            spec$1.state.dialogSwipeState.set(
              init$3(event.raw.touches[0].clientX)
            );
          }),
          run(touchmove(), function (_wrapper, simulatedEvent) {
            ...
            spec$1.state.dialogSwipeState.on(function (state) {
              simulatedEvent.event.prevent();
              spec$1.state.dialogSwipeState.set(
                move(state, event.raw.touches[0].clientX)
              );
            });
          }),
  ...
  var external = function (spec) {
    var extSpec = asRawOrDie$1(
      "external.component",
      objOfOnly([required$1("element"), option("uid")]),
      spec
    );
  ...
  var build$1 = function (spec) {
    return getPremade(spec).getOrThunk(function () {
      var userSpecWithUid = isSketchSpec(spec)
        ? spec
  ...
  var parts$2 = constant$1([
    group({
      ...
      defaults: function (detail, u) {
        return has$2(u, "uid")
          ? u
          : __assign(__assign({}, u), { uid: generate$2("item") });
      },
  ...
  var jumpTo = function (comp, transConfig, transState, destination) {
    ...
    if (
      ...
      get$b(comp.element, transConfig.stateAttr) !== destination
    ) {
    ...
    var memMenu = record(
      tieredMenu.sketch({
        ...
        onCollapseMenu: function (container, item, menu) {
          var submenu = ancestor(item.element, '[role="menu"]').getOrDie(
            "hacky"
          );
  ...
  var getFirstRect$1 = function (rng) {
    ...
    return rect.width > 0 || rect.height > 0
      ? Optional.some(rect).map(toRect$1)
      : Optional.none();
  };
  ...
  var create$2 = function (platform, mask) {
    ...
    var enter = function () {
      ...
      androidApi.set(
        setup$2(platform.win, getWin(platform.editor).getOrDie("no"))
      );
      getActiveApi(platform.editor).each(function (editorApi) {
        clobberStyles(platform.container, editorApi.body);
        androidEvents.set(
          initEvents$1(editorApi, platform.toolstrip, platform.alloy)
        );
      });
    };
    var exit = function () {
  ...
  var initEvents = function (editorApi, iosApi, toolstrip, socket, _dropup) {
    ...
    var listeners = [
      ...
      bind(editorApi.doc, "touchend", function (touchEvent) {
        if (
          eq(editorApi.php, touchEvent.target) ||
  ...
  var classify = function (element) {
    ...
    var classifier =
      get$b(element, yScrollingData) === "true"
        ? classifyScrolling
        : classifyFixed;
  ...
  var renderMobileTheme = function (editor) {
    var renderUI = function () {
      ...
      var realm = detect$1().os.isAndroid()
